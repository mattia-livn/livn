...
export const imuRatesBitettoBA2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato dentro il centro storico",
  ...
  {
    condition: "Abitazione a disposizione dentro il centro storico",
