...
export const imuRatesVietriSulMareSA2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 0.795
    categoryTypes: []
    context: "Locazione - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
