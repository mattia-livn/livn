...
export const imuRatesBorgoVirgilioMN2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili concessi in comodato a ONLUS o altri enti del terzo settore",
    details: "Fabbricati a disposizione o utilizzati: Immobili concessi in comodato - Requisiti soggettivi del comodatario: ONLUS o altri enti del terzo setto",
    ratePercent: 0.76
    categoryTypes: []
  ...
  {
    condition: "Immobili di categoria A10, C concessi in comodato a ONLUS o altri enti",
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili concessi in comodato - Requisiti soggettivi del comodatario: ONLUS o altri enti",
    ratePercent: 0.65
    categoryTypes: ["A10","C"]
    context: "ONLUS o altri enti"
  ,
    requiredParameters: {
      required: [
      {
