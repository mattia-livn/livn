...
export const imuRatesDormellettoNO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Aree fabbricabili - Tipologia: Diverse da residenziali - Situate in determinate zone",
    details: "Aree Fabbricabili - Tipologia: Diverse da residenziali - Situate in determinate zone: per le aree industriali di nuovo impianto, destinate unicamente alla rilocalizzazione di attività produttive, industriali o artigianali esistenti, irrazionalmente dislocate sul territorio comunale.",
    ratePercent: 0.46
    categoryTypes: []
    context: "Per le aree industriali di nuovo impianto"
    zone: "Destinate unicamente alla rilocalizzazione di attività produttive, industriali o artigianali esistenti"
  ,
    requiredParameters: {
            "required": [
                  {
