...
export const imuRatesFornovoDiTaroPR2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "A e Fabbricabili - Tipologia: Residenziali - Situate in determinate zone: ZONA AM ITO EX POC: RIC R01, FOR R06, LAS R01, LAS R03, LAS R04, LAS R05, SIV R01, RIC P01 AREE DI ESPANSIONE DEL PSC PER CUI NON E' STATA AVVIATA L'ATTIVAZIONE - L. R. 24/2017",
    ratePercent: 0
    categoryTypes: []
    zone: "ZONA AM ITO EX POC: RIC R01, FOR R06, LAS R01, LAS R03, LAS R04, LAS R05, SIV R01, RIC P01"
  ,
    requiredParameters: {
            "required": [
                  {
