...
export const imuRatesSanPossidonioMO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Periodo non coperto da contratti purché la condizione di immobile a disposizione persista da almeno: 1",
    ratePercent: 1.06
    categoryTypes: []
  ,
    requiredParameters: {
