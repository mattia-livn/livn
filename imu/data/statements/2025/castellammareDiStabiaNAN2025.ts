...
export const imuRatesCastellammareDiStabianan2025: ImuRateEntry[] = [
  ...
  ,
    requiredParameters: {
            ...
            "commune": "castellammareDiStabiaN"
      },
  {
  ...
  {
    condition: "Terreni agricoli ricadenti in aree montane o di collina",
    details: "- Collocazione: Ter ni ricadenti in determinate a e: A a: ai sensi dell'art. 7 comma 1 lett. h del D. Lgs. n. 504 del 1992 ricadenti in a e montane o di collina delimitate ai sensi della legge 27 dicemb 1977, n. 984",
    ratePercent: 0
    categoryTypes: []
