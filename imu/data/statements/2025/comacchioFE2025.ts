...
export const imuRatesComacchioFE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Altri fabbricati locati o in comodato",
  ...
  {
    condition: "Altri fabbricati locati ai sensi dell'art. 2, comma 3, della Legge n.431/1998",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. - Limitatamente ad un solo immobile.",
    ratePercent: 0.86
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria A10, C utilizzati da ONLUS o altri enti del terzo settore",
