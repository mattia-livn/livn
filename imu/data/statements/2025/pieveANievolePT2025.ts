...
export const imuRatesPieveANievolePT2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri",
    ratePercent: 0.95
  ...
  {
    condition: "Abitazione locata o in comodato, tipo contratto: Comodato d'uso gratuito, categorie catastali A/2, A/3, A/4, A/5, A/6, A/7, A/11",
  ...
  {
    condition: "Abitazione locata o in comodato, tipo contratto: Locazione o comodato d'uso gratuito, categorie catastali A/1, A/8, A/9",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito Categoria catastale: - A/1 Abitazioni di tipo signorile - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti p gi artistici o storici",
    ratePercent: 1.06
    categoryTypes: ["A/1","A/8","A/9"]
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Periodo non coperto da contratti purché la condizione di immobile a disposizione persista da almeno: 12",
    ratePercent: 1.06
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato, tipo contratto: Comodato d'uso gratuito, categorie catastali A/2, A/3, A/4, A/5, A/6, A/7, A/11, con contratto registrato",
