...
export const imuRatesCivitellaDiRomagnaFC2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D con specifiche destinazioni d'uso",
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D con specifiche destinazioni d'uso per ONLUS o altri enti del terzo settore",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : ONLUS o altri enti del terzo settore - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 1.02
    categoryTypes: ["D/6","D/7","D/8"]
  ,
    requiredParameters: {
      required: [],
      conditional: [],
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D con specifiche destinazioni d'uso",
    ...
    ratePercent: 0.76
    categoryTypes: ["A/10","C/1","C/3","C/4"]
  ,
    requiredParameters: {
            "required": [
                  {
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D con specifiche destinazioni d'uso per ONLUS o altri enti del terzo settore",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : ONLUS o altri enti del terzo settore - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 1.02
    categoryTypes: ["A/10","C/1","C/3","C/4"]
  ,
