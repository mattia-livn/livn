...
export const imuRatesGodiascoSaliceTermePV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/2 e D/4",
    details: "Categoria catastale: - D/2 Alberghi e pensioni con fine di lucro - D/4 Case di cura ed ospedali con fine di lucro",
    ratePercent: 0.96
    categoryTypes: ["D/2","D/4"]
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria catastale D/2 senza fine di lucro",
