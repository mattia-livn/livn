...
export const imuRatesLaglioCO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione utilizzata di ttamente dal soggetto passivo Categoria catastale: - A/1 Abitazioni di tipo signorile - A/7 Abitazioni in villini - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti p gi artistici o storici",
    ratePercent: 1.06
    categoryTypes: ["A/1","A/7","A/8","A/9"]
  ,
    requiredParameters: {
      required: [],
      conditional: [],
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/1 Abitazioni di tipo signorile - A/7 Abitazioni in villini - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti p gi artistici o storici",
    ratePercent: 1.06
    categoryTypes: ["A/1","A/7","A/8","A/9"]
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito Categoria catastale: - A/1 Abitazioni di tipo signorile - A/7 Abitazioni in villini - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti",
    ratePercent: 1.06
    categoryTypes: ["A/1","A/7","A/8","A/9"]
  ,
    requiredParameters: {
