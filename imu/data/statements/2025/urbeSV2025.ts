...
export const imuRatesUrbeSV2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Collocazione immobile: In una zona specificamente indicata dal comune: Immobili ubicati in zone in frana attiva, come individuate dagli strumenti urbanistici in vigo",
    ratePercent: 0.8
    categoryTypes: []
    context: "Immobili ubicati in zone in frana attiva"
