...
export const imuRatesOrnavassoVB2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Collocazione immobile: In una zona specificamente indicata dal comune: Abitazioni montane Ornavasso capoluogo olt i 528 metri s.l.m. - Frazione Migiandone olt 300 metri s.l.m. di sidenti ad Ornavasso",
    ratePercent: 0.76
    categoryTypes: []
    context: "Abitazioni montane"
    zone: "Ornavasso capoluogo oltre 528 metri s.l.m., Frazione Migiandone oltre 300 metri s.l.m."
  ,
    requiredParameters: {
      required: [
      {
