...
export const imuRatesCodigoroFE2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    details: "- C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri",
    ratePercent: 0.86
    categoryTypes: ["C/1","C/3"]
  },
  {
    condition: "Immobili di categoria A10, categoria catastale A/10 Uffici e studi privati",
