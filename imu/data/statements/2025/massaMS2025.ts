...
export const imuRatesMassaMS2025: ImuRateEntry[] = [
  ...
  {
    condition: "Terreni agricoli in frazioni montane",
    details: "Ter ni ricadenti in determinate a e: A a: FRAZIONI MONTANE",
    ratePercent: 0
    categoryTypes: []
    context: "Frazioni montane"
  },
  {
  ...
  {
    condition: "Abitazione locata o in comodato, contratto di locazione ai sensi dell'art. 5, comma 1, della Legge n. 431/1998",
