...
export const imuRatesFalconaraMarittimaAN2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone destinate a verde",
    details: "Aree fabbricabili - Situate in determinate zone: A e edificabile destinate a verde come da D.C. n. 19 del 20/04/2022 AD OGG TO: “VALORIZZAZIONE AM IENTALE DI AREE EDIFICA ILI MEDIANTEPIANTUMAZIONE CON AZZERAMENTO ALIQUOTA IMU”",
    ratePercent: 0
    categoryTypes: []
    context: "Valorizzazione ambientale mediante piantumazione"
    zone: "Zone destinate a verde"
  ,
    requiredParameters: {
            "required": [
                  {
  ...
  {
    condition: "Immobili di categoria C/4 per esercizi sportivi senza fine di lucro",
    details: "Immobili di categoria C Categoria catastale: - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - Collocazione immobile: In una zona specificamente indicata dal comune: ZONA SAT 1-ZUD 3 CON VINCOLO D'USO S5 \"RICREATIVO CULTURALE\"",
    ratePercent: 0.1
    categoryTypes: ["C/4"]
    context: "Esercizi sportivi senza fine di lucro"
    zone: "ZONA SAT 1-ZUD 3"
  ,
    requiredParameters: {
      required: [
      {
