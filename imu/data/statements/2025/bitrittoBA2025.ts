...
export const imuRatesBitrittoBA2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- Tipologia: Residenziali - Situate in determinate zone: AREE EDIFICA ILI INDIVIDUATE NEL PRGC PER LE ZONE A2,C1,C2 E 3",
    ratePercent: 0.7
    categoryTypes: []
    zone: "AREE EDIFICABILI INDIVIDUATE NEL PRGC PER LE ZONE A2,C1,C2 E 3"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di locazione ai sensi dell'art. 5, comma 1, della Legge n. 431/1998",
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 12 - Destinazione d'uso: Utilizzato per attivita' produttiva e/o",
    ratePercent: 0.86
