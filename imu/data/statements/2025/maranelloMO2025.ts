...
export const imuRatesMaranelloMO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Terreni agricoli in zone svantaggiate montane",
    details: "Ter ni ricadenti in determinate a e: A a: zone svantaggiate montane Fogli 10-11-13-15-16-17-18- dal 20 al 35fogli parzialmente delimitati nr. 8 - 6- 12- 14- 19",
    ratePercent: 0
    categoryTypes: []
    zone: "zone svantaggiate montane"
  ,
    requiredParameters: {
            "required": [
                  {
