...
export const imuRatesAcutoFR2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    context: "Con contratto registrato e utilizzata come abitazione principale"
  },
  {
    condition: "Abitazione locata o in comodato con contratto registrato, ipotesi diverse da quelle di cui all'art. 1, comma 747, lett. c",
    ...
    ratePercent: 0.76
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"]
    context: "Con contratto registrato, ipotesi diverse da quelle di cui all'art. 1, comma 747, lett. c"
  }
];
