...
export const imuRatesTermeVigliatoreME2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "A e Fabbricabili - Situate in determinate zone: ZONA C4 _ A MONTE DEL CIMITERO DI VIGLIATORE",
    ratePercent: 0.26
    categoryTypes: []
    zone: "ZONA C4 _ A MONTE DEL CIMITERO DI VIGLIATORE"
  ,
    requiredParameters: {
            "required": [
                  {
