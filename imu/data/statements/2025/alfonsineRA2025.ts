...
export const imuRatesAlfonsineRA2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    details: "- Tipologia: Diverse da sidenziali - Situate in determinate zone: in a e con vincolo p ordinato all'esproprio",
    ratePercent: 0.53
    categoryTypes: []
    context: "Situate in determinate zone con vincolo preordinato all'esproprio"
  },
  {
    condition: "Fabbricati residenziali situati in determinate zone con delibera di vincolo preordinato all'esproprio",
    details: "- Tipologia: Residenziali - Situate in determinate zone: a a con delibera di vincolo p ordinato all'esproprio",
    ratePercent: 0.53
    categoryTypes: []
    context: "Situate in determinate zone con delibera di vincolo preordinato all'esproprio"
  },
  {
    condition: "Fabbricati residenziali situati in centro storico durante interventi di recupero",
    details: "- Tipologia: Residenziali - Situate in determinate zone: in centro storico durante interventi di cupero",
    ratePercent: 0.1
    categoryTypes: []
    context: "Situate in centro storico durante interventi di recupero"
  },
  {
    condition: "Fabbricati diversi da residenziali situati in centro storico durante interventi di recupero",
  ...
  },
  {
    ...
    ratePercent: 0
    categoryTypes: []
    context: "Non locate, non concesse in comodato, inagibili a seguito di calamità naturali"
  }
];
