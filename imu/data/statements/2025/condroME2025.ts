...
export const imuRatesCondroME2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli non coltivati",
    details: "- Utilizzo: Non coltivati - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 1",
    ratePercent: 0.76
    categoryTypes: []
    context: "Non coltivati"
    zone: "Riferimento ai fogli catastali: 1"
  ,
    requiredParameters: {
            "required": [
                  {
