...
export const imuRatesPrivernoLT2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione destinata a struttura turistico-ricettiva - Collocazione immobile: Dentro il centro storico - Attività condotta in forma imprenditoriale",
    details: "Abitazione destinata a struttura turistico-ricettiva - Collocazione immobile: Dentro il centro storico - Attività condotta in forma imprenditoriale",
    ratePercent: 0.5
    categoryTypes: []
