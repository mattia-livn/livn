...
export const imuRatesTorreDeNegriPV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato e destinazione d'uso come abitazione principale",
