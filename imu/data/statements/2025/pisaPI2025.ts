...
export const imuRatesPisaPI2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona fisica di eta' non superio ad anni: 100 - Destinazione d'uso: Immobili non produttivi di ddito fondiario art. 43 T.U.I.R.",
    ratePercent: 1.01
    categoryTypes: ["A10","C"]
    context: "Requisiti soggettivi del soggetto passivo utilizzato : Persona fisica di eta' non superio ad anni: 100"
  },
  {
    condition: "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo",
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 1 - Destinazione d'uso: Immobili non produttivi di ddito fondiario art. 43 T.U.I.R.",
    ratePercent: 1.01
    categoryTypes: ["A10","C"]
    context: "Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 1"
  }
];
