...
export const imuRatesMontespertoliFI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 0",
    ratePercent: 0.86
    categoryTypes: ["D"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati: Immobili a disposizione",
      ...
      },
  {
    ...
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 0",
    ratePercent: 0.86
    categoryTypes: ["A10","C"]
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019",
    ratePercent: 0.96
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C - Categoria catastale: C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo",
