...
export const imuRatesAdroBS2025: ImuRateEntry[] = [
  ...
  },
  {
    ...
    details: "A e Fabbricabili - Situate in determinate zone: TUTTE LE AREE DI NUOVA TRASFORMAZIONE INSERITE NEL PGT, SIA RESIDENZIALI CHE PRODUTTIVE",
    ratePercent: 1.06
    categoryTypes: []
    zone: "TUTTE LE AREE DI NUOVA TRASFORMAZIONE INSERITE NEL PGT, SIA RESIDENZIALI CHE PRODUTTIVE"
  },
  {
