...
export const imuRatesGrottammareAP2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Requisiti del soggetto passivo: Portatore di handicap grave riconosciuto ai sensi dell'art. 3, comma 3, della L. 104/92",
