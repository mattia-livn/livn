...
export const imuRatesMontalcinoSI2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al terzo grado in linea tta - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.8
    categoryTypes: []
    context: "Con contratto registrato, parenti sino al terzo grado"
  },
  {
    ...
    context: "Con contratto registrato, parenti sino al primo grado"
  },
  {
