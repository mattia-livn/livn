...
export const imuRatesMatinoLE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D in Zone Economiche Speciali",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Collocazione immobile: In una zona specificamente indicata dal comune: ZES Zone Economiche Speciali individuate con Deliberazione CC n. 30/2023",
    ratePercent: 0.76
    categoryTypes: ["D/1","D/7","D/8"]
    context: "In una zona specificamente indicata dal comune"
    zone: "ZES Zone Economiche Speciali"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
  ...
  {
    condition: "Immobili di categoria C in Centro Storico per attività avviate dal 1 gennaio 2022",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: In una zona specificamente indicata dal comune: CENTRO STORICO per attività avviate dal 1^ gennaio 2022 e per la durata massima di sette anni",
    ratePercent: 0
    categoryTypes: ["C/1","C/3"]
    context: "Per attività avviate dal 1 gennaio 2022 e per la durata massima di sette anni"
    zone: "CENTRO STORICO"
  ,
    requiredParameters: {
      required: [],
