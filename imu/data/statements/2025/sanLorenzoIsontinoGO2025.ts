...
export const imuRatesSanLorenzoIsontinoGO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
...
},
  {
    ...
    context: "Aliquota ordinaria per l'abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    context: "Aliquota per immobili diversi dall'abitazione principale"
  ,
    requiredParameters: {
            "required": [
                  {
