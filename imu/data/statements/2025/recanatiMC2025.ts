...
export const imuRatesRecanatiMC2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.86
    categoryTypes: []
    context: "Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale"
  ,
    requiredParameters: {
      required: [
      {
