...
export const imuRatesSanBonifacioVR2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Locazione o comodato d'uso gratuito, utilizzata come abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
