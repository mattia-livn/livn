...
export const imuRatesPaitoneBS2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili a disposizione - Purché la condizione di immobile a disposizione persista da almeno: 6 mesi",
    ratePercent: 0.88
    categoryTypes: ["C/1"]
    context: "Immobili a disposizione da almeno 6 mesi"
  ,
    requiredParameters: {
      required: [
      {
