...
export const imuRatesCesateMI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/2 Magazzini e locali di deposito - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte",
    ratePercent: 0.98
    categoryTypes: ["C"]
  ,
    requiredParameters: {
    ...
    },
  {
    ...
    details: "Alloggi golarmente assegnati dagli IACP o dagli enti di edilizia sidenziale pubblica aventi le",
    ratePercent: 0.76
    categoryTypes: []
  ,
    requiredParameters: {
