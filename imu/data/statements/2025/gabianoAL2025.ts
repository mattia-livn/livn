...
export const imuRatesGabianoAL2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta - Limitatamente ad un solo immobile.",
    ratePercent: 0.61
    categoryTypes: []
    context: "Con contratto registrato, parenti sino al secondo grado in linea retta, limitatamente ad un solo immobile"
  ,
    requiredParameters: {
      required: [
      {
