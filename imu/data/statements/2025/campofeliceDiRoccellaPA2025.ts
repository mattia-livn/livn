...
export const imuRatesCampofeliceDiRoccellaPA2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- Utilizzo: Ter ni agricoli condotti da CD e IAP e Societa' agricole non posseduti",
    ratePercent: 0
    categoryTypes: []
  ,
    requiredParameters: {
    ...
    },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola",
    ratePercent: 0.765
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - Collocazione immobile: In una zona specificamente indicata dal comune: Fabbricati rurali categoria C/2 e C/6 con annotazione strumentalit�",
    ratePercent: 0.1
    categoryTypes: ["C/2","C/6"]
    context: "Fabbricati rurali con annotazione strumentalità"
