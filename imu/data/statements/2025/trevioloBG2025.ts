...
export const imuRatesTrevioloBG2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/4 Case di cura ed ospedali con fine di lucro",
    details: "Categoria catastale: - D/4 Case di cura ed ospedali con fine di lucro",
    ratePercent: 0.76
    categoryTypes: ["D/4"]
    context: "Case di cura ed ospedali con fine di lucro"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D, immobili di categoria",
