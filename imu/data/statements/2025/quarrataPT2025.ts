...
export const imuRatesQuarrataPT2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di comodato d'uso gratuito tra parenti sino al primo grado",
    ...
    ratePercent: 0.86
    categoryTypes: []
    context: "Sino al primo grado, purché l'affittuario/comodatario la utilizzi come abitazione principale"
  },
  {
    condition: "Abitazione locata o in comodato con contratto di comodato d'uso gratuito tra parenti indipendentemente dal grado di parentela",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Indipendentemente dal grado di pa ntela",
    ratePercent: 1.06
    categoryTypes: []
    context: "Indipendentemente dal grado di parentela"
  },
  {
