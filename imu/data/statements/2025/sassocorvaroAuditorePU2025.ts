...
export const imuRatesSassocorvaroAuditorePU2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D con impianti fotovoltaici",
    details: "Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Destinazione d'uso: Impianti fotovoltaici",
    ratePercent: 1.06
    categoryTypes: ["D/1"]
  ,
    requiredParameters: {
