...
export const imuRatesIncudineBS2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C, categoria C/2 Magazzini e locali di deposito",
    ...
    ratePercent: 0.53
    categoryTypes: ["C/2"]
    zone: "Situate al di fuori del perimetro urbano, aree tipiche di montagna non ristrutturate"
  ,
    requiredParameters: {
      required: [
      {
