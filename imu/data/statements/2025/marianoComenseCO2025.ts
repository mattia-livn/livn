...
export const imuRatesMarianoComenseCO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria A/10, C utilizzati per attività produttiva e/o commerciale",
  ...
  {
    condition: "Immobili di categoria A/10, C di proprietà di ONLUS o enti del terzo settore",
