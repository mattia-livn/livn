...
export const imuRatesSestaGodanoSP2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie D/4 e D/5",
    details: "Categoria catastale: - D/4 Case di cura ed ospedali con fine di lucro - D/5 Istituto di credito, cambio e assicurazione con fine di lucro",
    ratePercent: 1.06
