...
export const imuRatesLatinaLT2025: ImuRateEntry[] = [
  ...
  },
  {
    ...
    ratePercent: 0.91
    categoryTypes: ["A/10","C/1","C/2","C/3","C/7"]
    context: "Utilizzato per attività produttiva e/o commerciale o per l'esercizio di arti e professioni"
  },
  {
  ...
  },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione a studenti ai sensi",
    ratePercent: 0.76
    categoryTypes: []
  ...
  },
  {
    ...
    ratePercent: 0.76
    categoryTypes: []
    context: "Durata del contratto di durata non inferiore a mesi, specifica: 1"
  },
  {
