...
export const imuRatesVicoEquensenan2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di comodato d'uso gratuito con condizioni specifiche",
    details: "- A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.8
