...
export const imuRatesControguerraTE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/1 Negozi e botteghe, immobili a disposizione",
    details: "Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili a disposizione - Purché la condizione di immobile a disposizione persista da almeno: 12 mesi",
    ratePercent: 0.76
    categoryTypes: ["C/1"]
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/1 Negozi e botteghe, immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo",
    details: "Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.86
    categoryTypes: ["C/1"]
