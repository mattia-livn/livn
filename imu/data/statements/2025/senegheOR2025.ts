...
export const imuRatesSenegheOR2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di fatto dell' immobile tutti - Destinazione d'uso: Utilizzato per attività produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.76
    categoryTypes: ["D"]
  ,
    requiredParameters: {
