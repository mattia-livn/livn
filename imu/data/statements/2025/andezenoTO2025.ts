...
export const imuRatesAndezenoTO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C concessi in comodato",
    details: "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte - Fabbricati a disposizione o utilizzati: Immobili concessi in comodato - Limitatamente ad un solo immobile.",
    ratePercent: 0.76
