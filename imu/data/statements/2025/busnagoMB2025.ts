...
export const imuRatesBusnagoMB2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria catastale A/4 Uffici pubblici",
    details: "Immobili di categoria Categoria catastale: - /4 Uffici pubblici",
    ratePercent: 0
    categoryTypes: ["A/4"]
    context: "Uffici pubblici"
  ,
    requiredParameters: {
      required: [
      {
