...
export const imuRatesCantuCO2025: ImuRateEntry[] = [
  ...
  },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Accordi/Patti territoriali per soddisfa particolari esigenze abitative come definiti nel golamento - Durata del contratto di durata non inferio a mesi, specifica : 18",
    ratePercent: 0.27
    categoryTypes: []
  }
];
