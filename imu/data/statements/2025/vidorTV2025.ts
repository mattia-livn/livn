...
export const imuRatesVidorTV2025: ImuRateEntry[] = [
    ...
    },
  {
    ...
    details: "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/2 Magazzini e locali di deposito - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte",
    ratePercent: 0.88
    categoryTypes: ["A/10","C/2","C/6","C/7"]
  ,
    requiredParameters: {
      required: [
      {
