...
export const imuRatesCalcinaiaPI2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    details: "Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Immobili non produttivi di ddito fondiario art. 43 T.U.I.R.",
    ratePercent: 0.87
    categoryTypes: ["D"]
    context: "Immobili non produttivi di reddito fondiario"
  },
  {
  ...
  },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Requisiti del soggetto passivo: Di proprietà di ONLUS o enti del terzo setto",
    ratePercent: 0.53
    categoryTypes: []
    context: "Di proprietà di ONLUS o enti del terzo settore"
  },
