...
export const imuRatesAltavillaVicentinaVI2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Comodato d'uso gratuito, contratto registrato, utilizzo come abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
