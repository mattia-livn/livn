...
export const imuRatesVejanoVT2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Aree Fabbricabili - Situate in determinate zone: Riduzione del 25% dell'importo totale dovuto, esclusivamente sulle aree edificabili",
    ratePercent: 1
    categoryTypes: []
    context: "Riduzione del 25% dell'importo totale dovuto"
