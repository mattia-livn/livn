...
export const imuRatesAlzanoLombardoBG2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 250 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Privi o che intendono dismette giochi di azzardo - Codice ATECO: 47.1 - COMMERCIO AL D TAGLIO IN ESERCIZI NON SPECIALIZZATI",
    ratePercent: 0.76
    categoryTypes: ["C/1"]
    context: "Privi o che intendono dismettere giochi di azzardo"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe con superficie non superiore a 250 MQ",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 250 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Privi o che intendono dismette giochi di azzardo - Codice ATECO: 47.2 - COMMERCIO AL D TAGLIO DI PRODOTTI ALIMENTARI, EVANDE E TA ACCO IN ESERCIZI SPECIALIZZATI",
    ratePercent: 0.76
    categoryTypes: ["C/1"]
    context: "Privi o che intendono dismettere giochi di azzardo"
  ,
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe con superficie non superiore a 250 MQ",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 250 MQ",
    ratePercent: 0.76
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
