...
export const imuRatesBottanucoBG2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.86
    categoryTypes: ["C/1"]
    context: "Destinazione d'uso: bottega storica o artigiana"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
