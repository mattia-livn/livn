...
export const imuRatesLacchiarellaMI2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria C locati per attività produttiva e/o commerciale",
    ...
    context: "Locati per attività produttiva e/o commerciale"
  ,
    requiredParameters: {
      required: [],
      conditional: [
