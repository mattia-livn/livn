...
export const imuRatesPonteDellolioPC2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Supermercati",
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 47.11.2 - Supermercati",
    ratePercent: 1.06
    categoryTypes: ["D"]
    context: "Codice ATECO: 47.11.2"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Discount di alimentari",
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 47.11.3 - Discount di alimentari",
    ratePercent: 1.06
    categoryTypes: ["D"]
    context: "Codice ATECO: 47.11.3"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
      ...
      },
  {
    ...
    ratePercent: 0.9
    categoryTypes: ["C/1"]
    context: "Destinazione d'uso: Utilizzato per attività produttiva e/o commerciale o per l'esercizio di arti e professioni"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
