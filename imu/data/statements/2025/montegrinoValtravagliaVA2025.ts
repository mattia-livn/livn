...
export const imuRatesMontegrinoValtravagliaVA2025: ImuRateEntry[] = [
  ...
  ,
    requiredParameters: {
            ...
            "commune": "montegrinoValtravaglia"
      },
  {
  ...
  {
    condition: "Immobili di categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /5 Scuole e laboratori scientifici",
    details: "Immobili di categoria Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /5 Scuole e laboratori scientifici",
    ratePercent: 0
    categoryTypes: ["/1","/5"]
  ,
    requiredParameters: {
