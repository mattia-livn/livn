...
export const imuRatesFioranoModeneseMO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: Fg. nr.13-18-19-20-21 e dal nr.23 al nr.31 comp so : PER INTERO // Fg. nr. 17 e nr. 22 PARZIALMENTE",
    ratePercent: 0
    categoryTypes: []
    context: "Ricadenti nei fogli catastali specificati"
    zone: "Fg. nr.13-18-19-20-21 e dal nr.23 al nr.31 per intero, Fg. nr. 17 e nr. 22 parzialmente"
  ,
    requiredParameters: {
      required: [],
      conditional: [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.57
