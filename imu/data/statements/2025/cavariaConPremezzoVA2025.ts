...
export const imuRatesCavariaConPremezzoVA2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- esercizi commerciali e artigianali situati in zone p cluse al traffico a causa dello svolgimento di lavori per la alizzazione di ope pubbliche che si protraggono per olt sei mesi art. 1, comma 86, della legge n. 549 del 1995 con aliquota agevolata applicata: 0,5%;",
    ratePercent: 0.5
    categoryTypes: []
    ...
    },
  {
    ...
    details: "- immobili conferiti in trust istituito a favo di persone con handicap grave di cui all'art. 6 della legge n. 112 del 2016 con aliquota agevolata applicata: 0,5%;",
    ratePercent: 0.5
    categoryTypes: []
      ...
      },
  {
    ...
    details: "- immobili di propriet� di ONLUS o enti del terzo setto con eventuali condizioni dell'esenzione p senti nel golamento: L'attivit� svolta dalla ONLUS o dall' S deve esse di caratte NON commerciale con obbligo di dichiarazione.",
    ratePercent: 0
    categoryTypes: []
    context: "Attività non commerciale con obbligo di dichiarazione"
  ,
    requiredParameters: {
      required: [],
      conditional: [
