...
export const imuRatesCarugateMI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato, utilizzata come abitazione principale, sino al secondo grado in linea retta e collaterale",
    details: "- A/11 Abitazioni ed alloggi tipici dei luoghi - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale - Locatario/comodatario non titola di propriet� o altro diritto ale di godimento su immobili - Destinazione d'uso: Purch� l'affittuario/comodatario la utilizzi come abitazione principale. - Limitatamente ad un solo immobile.",
    ratePercent: 0.6
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7","A/11"]
  },
  {
    condition: "Abitazione locata con contratto ai sensi dell'art. 5, comma 1, della Legge n. 431/1998 e s.m.i.",
