...
export const imuRatesPortogruaroVE2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria utilizzati per scopi istituzionali o di pubblica utilità, senza fine di lucro",
    details: "Immobili di categoria Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzati per scopi istituzionali o di pubblica utilita', senza fine di lucro - Codice ATECO: 87.10.00 - Struttu di assistenza infermieristica sidenziale per anziani",
    ratePercent: 0.23
    categoryTypes: []
  }
];
