...
export const imuRatesSaluzzoCN2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli - Collocazione: Terreni ricadenti in determinate aree: Area: Municipio di Castellar",
    details: "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: Municipio di Castellar",
    ratePercent: 0
    categoryTypes: []
    context: "Collocazione: Municipio di Castellar"
    zone: "Municipio di Castellar"
  ,
    requiredParameters: {
      required: [],
      conditional: [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Con contratto registrato",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Con contratto gistrato",
    ratePercent: 1
    categoryTypes: []
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ...
    ratePercent: 0.5
    categoryTypes: []
    context: "Destinazione d'uso: Abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C - Categoria catastale: C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro",
    details: "Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro",
    ratePercent: 0.9
      ...
      },
  {
    ...
    details: "Abitazione a disposizione",
    ratePercent: 1.06
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazioni non locate e non concesse in comodato - Fabbricati divenuti inagibili a seguito di calamità naturali",
    details: "Abitazioni non locate e non concesse in comodato - Fabbricati divenuti inagibili a seguito di calamità naturali",
    ratePercent: 1.06
    categoryTypes: []
