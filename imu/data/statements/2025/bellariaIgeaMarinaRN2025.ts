...
export const imuRatesBellariaIgeaMarinaRN2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del locatario, comodatario o soggetto passivo utilizzato : ONLUS o altri enti del terzo setto",
    ratePercent: 0.96
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Fabbricati a disposizione di proprietà di ONLUS o enti del terzo settore",
