...
export const imuRatesCastellanzaVA2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie D/4, D/5, D/8",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/4 Case di cura ed ospedali con fine di lucro - D/5 Istituto di credito, cambio e assicurazione con fine di lucro - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 1.06
    categoryTypes: ["D/4","D/5","D/8"]
  },
  {
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/6",
    details: "Immobili di categoria C Categoria catastale: - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili a disposizione",
    ratePercent: 1.06
    categoryTypes: ["C/6"]
  }
];
