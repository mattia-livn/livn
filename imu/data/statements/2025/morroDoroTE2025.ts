...
export const imuRatesMorroDoroTE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: E' p vista l'esenzione per i Ter ni agricoli collocati Dal Foglio n. 1 al Foglio n. 25 collocati sopra la S.S. 150",
    ratePercent: 0
    categoryTypes: []
    zone: "Dal Foglio n. 1 al Foglio n. 25 collocati sopra la S.S. 150"
  ,
    requiredParameters: {
            "required": [
                  {
