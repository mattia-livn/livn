...
export const imuRatesCastelfrancoEmiliaMO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 0.96
    categoryTypes: ["D/7"]
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato",
    ratePercent: 0.96
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.96
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata ai sensi dell'art. 2, comma 1, della Legge n. 431/1998",
  ...
  {
    condition: "Abitazione locata ai sensi dell'art. 5, comma 1, della Legge n. 431/1998",
  ...
  {
    condition: "Abitazione locata a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998",
  ...
  {
    condition: "Abitazione locata con accordi/patti territoriali per esigenze abitative particolari",
    details: "Abitazione locata o in comodato - Tipo contratto: Accordi/Patti territoriali per soddisfa particolari esigenze abitative come definiti nel golamento - Condizioni locatario/comodatario: Soggetto in condizioni di vulnerabilita' sociale/emergenza abitativa come definite nel golamento",
    ratePercent: 0.4
    categoryTypes: []
  ,
    requiredParameters: {
