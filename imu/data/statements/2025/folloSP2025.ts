...
export const imuRatesFolloSP2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: Ricadenti in area PG4",
    details: "A e Fabbricabili - Situate in determinate zone: Ricadenti in a e PG4",
    ratePercent: 0.46
    categoryTypes: []
    zone: "Ricadenti in area PG4"
  },
  {
    ...
    context: "Comodato d'uso gratuito, con contratto registrato, utilizzata come abitazione principale"
  }
];
