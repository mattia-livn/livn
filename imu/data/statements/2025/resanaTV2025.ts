...
export const imuRatesResanaTV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria C/1 locati a persone fisiche di età non superiore a 36 anni",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati - Requisiti soggettivi del locatario: Persona fisica di eta' non superio ad anni: 36",
    ratePercent: 0.3
    categoryTypes: ["C/1"]
    context: "Locati a persone fisiche di età non superiore a 36 anni"
  ,
    requiredParameters: {
      required: [
      {
