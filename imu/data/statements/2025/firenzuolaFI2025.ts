...
export const imuRatesFirenzuolaFI2025: ImuRateEntry[] = [
  ...
  },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati divenuti inagibili a seguito di calamità naturali",
    ratePercent: 0.76
    categoryTypes: ["D"]
  ...
  },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato nonche' abitazioni locate o concesse in comodato per periodi inferiori all'anno e comunque per un numero complessivo di mesi inferio a: mesi: 12 - Fabbricati divenuti inagibili a seguito di calamità naturali",
    ratePercent: 0
    categoryTypes: []
    context: "Non locate e non concesse in comodato o per periodi inferiori all'anno"
  }
];
