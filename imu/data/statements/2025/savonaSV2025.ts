...
export const imuRatesSavonaSV2025: ImuRateEntry[] = [
  {
  ...
  },
  {
    ...
    details: "Fabbricati di civile abitazione destinati ad alloggi sociali non adibiti ad abitazione principale per il periodo di espletamento delle attività di assegnazione Fino a mesi: 18",
    ratePercent: 0
    categoryTypes: []
    context: "Fino a mesi: 18"
  }
];
