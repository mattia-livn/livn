...
export const imuRatesMagionePG2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/1 Opifici, utilizzati direttamente dal soggetto passivo per impianti fotovoltaici",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Impianti fotovoltaici",
    ratePercent: 1.02
    categoryTypes: ["D/1"]
    context: "Impianti fotovoltaici"
  },
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie D/1, D/2, D/3, D/4, D/6, D/7, D/8, D/9, utilizzati direttamente dal soggetto passivo per attività produttiva e/o commerciale",
