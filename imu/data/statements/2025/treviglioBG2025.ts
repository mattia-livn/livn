...
export const imuRatesTreviglioBG2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria catastale /6",
    details: "Categoria catastale: - /6 iblioteche, pinacoteche, musei, gallerie, accademie che non hanno sede in edifici della categoria A/9",
    ratePercent: 0.76
    categoryTypes: ["/6"]
  },
  {
