...
export const imuRatesMonterotondoMarittimoGR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato, categorie A/2, A/3, A/4, A/5, A/6, A/7",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini",
    ratePercent: 0.76
  ...
  {
    condition: "Immobili di categoria C, categorie C/2, C/3, C/6, C/7",
    details: "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte",
    ratePercent: 0.76
    categoryTypes: ["C/2","C/3","C/6","C/7"]
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C, categoria C/1 a disposizione",
