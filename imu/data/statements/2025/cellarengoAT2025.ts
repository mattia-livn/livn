...
export const imuRatesCellarengoAT2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 5 - 6- 7- 8- 9- 10- 11- 12",
    ratePercent: 0
    categoryTypes: []
    zone: "fogli catastali: 5 - 6- 7- 8- 9- 10- 11- 12"
  ,
    requiredParameters: {
      required: [],
      conditional: [
