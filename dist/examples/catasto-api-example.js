...
exports.runCatastoDemo = runCatastoDemo;
 ...
 */
function loadCredentialsFromEnvLocal() {
    try {
...
async function esempioRicercaMirata() {
    ...
    try {
        ...
        if (risultato === null || risultato === void 0 ? void 0 : risultato.soggetti) {
...
//# sourceMappingURL=catasto-api-example.js.map