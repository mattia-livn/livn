...
async function testFinalSystem() {
    ...
    for (const testCase of testCases) {
        ...
        try {
            const result = await service.findBestCondition(testCase.fabbricato, testCase.userAnswers, 0, testCase.expectedCommune);
            console.log(`\n📊 RISULTATO:`);
            ...
            console.log(`   ⚖️ Condizione applicata: ${((_a = result.conditionMatched) === null || _a === void 0 ? void 0 : _a.condition) || 'Standard'}`);
            ...
            console.error(`   ❌ Errore per ${testCase.nome}:`, error.message);
        }
    }
...
//# sourceMappingURL=test-final-system.js.map