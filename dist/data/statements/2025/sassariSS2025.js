...
exports.imuRatesSassariSS2025 = void 0;
exports.imuRatesSassariSS2025 = [
    {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D - Categoria catastale: D/2, D/3, D/4, D/6, D/7",
        ...
        "conditions": [
            {
                "description": "L'entità ha categoria D/2 o D/3 o D/4 o D/6 o D/7",
                "predicate": "['D/2','D/3','D/4','D/6','D/7'].includes(entity.category)"
            }
        ]
    },
    {
    ...
    {
        "label": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto registrato - Condizioni locatario/comodatario: Parenti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019",
        "ratePercent": 0.00061,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
...
//# sourceMappingURL=sassariSS2025.js.map