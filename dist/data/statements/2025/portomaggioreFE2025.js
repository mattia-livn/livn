"use strict";
// portomaggioreFE2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesPortomaggioreFE2025 = void 0;
exports.imuRatesPortomaggioreFE2025 = [
    {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D, categorie D/1, D/7, D/8 utilizzati da imprese che hanno ampliato la propria attività economica",
        "ratePercent": 0.00091,
        "categoryTypes": [
            "D/1",
            "D/7",
        ...
        "officialDescription": "Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Tipologia di attivit�: Imp se che hanno ampliato la propria attivita' economica/aumentato l'occupazione come definite nel golamento",
        "conditions": [
            {
    ...
    {
        "label": "Immobili di categoria C utilizzati da persona giuridica esercente attività d'impresa",
        "ratePercent": 0.00046,
        "categoryTypes": [
            "C/1",
            "C/2",
        ...
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un",
        "conditions": [
            {
    ...
    {
        "label": "Immobili di categoria C utilizzati come bottega storica o artigiana",
        "ratePercent": 0.00046,
        "categoryTypes": [
            "C/1",
            "C/2",
    ...
    {
        "label": "Abitazione locata o in comodato con particolari condizioni",
        "ratePercent": 0.0004,
        "categoryTypes": [
            "A/2",
            "A/3",
...
//# sourceMappingURL=portomaggioreFE2025.js.map