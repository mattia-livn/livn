"use strict";
// campigliaMarittimaLI2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesCampigliaMarittimaLI2025 = void 0;
exports.imuRatesCampigliaMarittimaLI2025 = [
    {
    ...
    },
    {
        ...
        "ratePercent": 0,
        "officialDescription": "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 14, 15, 16, 20, 21, 22, 23, 24, 25, 26, 33, 34, 35, 36, 37, 38, 39, 48, 49, 50, 51, 52, 53, 54, 55.",
        "conditions": [
            {
                "description": "È un terreno agricolo",
                "predicate": "entity.type === 'terreno' && entity.isAgricultural === true"
    ...
    },
    {
        ...
        "ratePercent": 0.00075,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Destinazione d'uso: Purché l'affittuario/comodatario la",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    },
    {
        ...
        "ratePercent": 0.00091,
        "officialDescription": "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.20.51 - Affittacame per b vi soggiorni, case ed appartamenti per vacanze, bed and b akfast, sidence - Attivit� condotta in forma imp nditoriale",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
...
//# sourceMappingURL=campigliaMarittimaLI2025.js.map