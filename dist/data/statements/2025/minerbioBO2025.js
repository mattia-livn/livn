...
exports.imuRatesMinerbioBO2025 = void 0;
exports.imuRatesMinerbioBO2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/2 Alberghi e pensioni con fine di lucro - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro",
        "conditions": [
            {
                "description": "L'entità ha categoria D/2 o D/3 o D/6",
                "predicate": "['D/2','D/3','D/6'].includes(entity.category)"
            }
        ]
    },
    {
        ...
        "conditions": [
            {
                "description": "L'entità ha categoria C/1 o C/2 o C/3 o C/4 o C/5 o C/6 o C/8",
                "predicate": "['C/1','C/2','C/3','C/4','C/5','C/6','C/8'].includes(entity.category)"
            }
        ]
    },
    {
...
//# sourceMappingURL=minerbioBO2025.js.map