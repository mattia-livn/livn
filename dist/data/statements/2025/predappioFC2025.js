...
exports.imuRatesPredappioFC2025 = void 0;
exports.imuRatesPredappioFC2025 = [
    {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D, categorie catastali D/1, D/2, D/3, D/4, D/6, D/7, D/8",
        "ratePercent": 0.00102,
        "categoryTypes": [
            "D/1",
            "D/2",
    ...
    },
    {
        ...
        "officialDescription": "- C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro",
        "conditions": [
            {
    ...
    },
    {
        ...
        "ratePercent": 0,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione - Fabbricati divenuti inagibili a seguito di calamit� naturali",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
...
//# sourceMappingURL=predappioFC2025.js.map