"use strict";
// voltagoAgordinoBL2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesVoltagoAgordinoBL2025 = void 0;
exports.imuRatesVoltagoAgordinoBL2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Categoria catastale: - D/1 Opifici - D/2 Alberghi e pensioni con fine di lucro - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attività industriale e non suscettibili di destinazione diversa senza radicali trasformazioni",
        "conditions": [
            {
                "description": "L'entità ha categoria D/1 o D/2 o D/6 o D/7",
                "predicate": "['D/1','D/2','D/6','D/7'].includes(entity.category)"
            }
        ]
    },
    {
        ...
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito Categoria catastale: - A/11 Abitazioni ed alloggi tipici dei luoghi",
        "conditions": [
            {
    ...
    },
    {
        ...
        "officialDescription": "Immobili di categoria , C Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /4 Uffici pubblici - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - C/7 Tettoie chiuse od aperte",
        "conditions": [
            {
                "description": "L'entità ha categoria /1 o /4 o C/1 o C/3 o C/4 o C/7",
                "predicate": "['/1','/4','C/1','C/3','C/4','C/7'].includes(entity.category)"
            }
        ]
    },
    {
...
//# sourceMappingURL=voltagoAgordinoBL2025.js.map