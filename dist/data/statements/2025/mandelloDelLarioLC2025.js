"use strict";
// mandelloDelLarioLC2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesMandelloDelLarioLC2025 = void 0;
exports.imuRatesMandelloDelLarioLC2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile tutti - Destinazione d'uso: Immobili non produttivi di ddito fondiario art. 43 T.U.I.R.",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    },
    {
        ...
        "ratePercent": 0.00046,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Immobili di categoria C/1, C/3, C/4, C/5",
        "ratePercent": 0.0009599999999999999,
        "categoryTypes": [
            "C/1",
            "C/3",
        ...
        "officialDescription": "- C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - C/5 Stabilimenti balneari e di acque curative senza fine di lucro",
        "conditions": [
            {
...
//# sourceMappingURL=mandelloDelLarioLC2025.js.map