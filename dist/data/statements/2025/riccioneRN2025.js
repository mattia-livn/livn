...
exports.imuRatesRiccioneRN2025 = void 0;
exports.imuRatesRiccioneRN2025 = [
    {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D, categorie D/1, D/3, D/4, D/6, D/7",
        "ratePercent": 0.00083,
        "categoryTypes": [
            "D/1",
            "D/3",
        ...
        "conditions": [
            {
                "description": "L'entità ha categoria D/1 o D/3 o D/4 o D/6 o D/7",
                "predicate": "['D/1','D/3','D/4','D/6','D/7'].includes(entity.category)"
            }
        ]
    },
    {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D, categoria D/8, superficie non inferiore a 9000 MQ",
        "ratePercent": 0.00083,
        "categoryTypes": [
            "D/8"
        ],
        "officialDescription": "Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Superficie: Non inferio a Mq 9000 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Codice ATECO: 91.04.0 - Attivita' degli orti botanici, dei giardini zoologici e delle riserve naturali",
        "conditions": [
            {
                "description": "L'entità ha categoria D/8",
                "predicate": "['D/8'].includes(entity.category)"
    ...
    {
        "label": "Altri fabbricati di categoria C",
        "ratePercent": 0.00083,
        "categoryTypes": [
            "C/1",
            "C/2",
...
//# sourceMappingURL=riccioneRN2025.js.map