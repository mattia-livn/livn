"use strict";
// poggiridentiSO2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesPoggiridentiSO2025 = void 0;
exports.imuRatesPoggiridentiSO2025 = [
    {
    ...
    {
        "label": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: A/3 Abitazioni di tipo economico",
        "ratePercent": 0.00065,
        "categoryTypes": [
            "A/3"
        ],
    ...
    {
        "label": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: A/7 Abitazioni in villini",
        "ratePercent": 0.00085,
        "categoryTypes": [
            "A/7"
        ],
    ...
    {
        "label": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: A/4 Abitazioni di tipo popolare, A/5 Abitazioni di tipo ultrapopolare, A/6 Abitazioni di tipo rurale",
        ...
        "conditions": [
            {
                "description": "L'entità ha categoria A/4 o A/5 o A/6",
                "predicate": "['A/4','A/5','A/6'].includes(entity.category)"
            }
        ]
    }
];
//# sourceMappingURL=poggiridentiSO2025.js.map