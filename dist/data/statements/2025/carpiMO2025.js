...
exports.imuRatesCarpiMO2025 = void 0;
exports.imuRatesCarpiMO2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
    ...
    {
        "label": "Immobili di categoria C a disposizione",
        "ratePercent": 0.00106,
        "categoryTypes": [
            "C/1",
            "C/3"
        ],
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili a disposizione",
        "conditions": [
            {
                "description": "L'entità ha categoria C/1 o C/3",
                "predicate": "['C/1','C/3'].includes(entity.category)"
    ...
    },
    {
        ...
        "ratePercent": 0.00106,
        "officialDescription": "Abitazione a disposizione",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Abitazioni non locate e non concesse in comodato",
        "ratePercent": 0.00106,
        "officialDescription": "- Abitazioni non locate e non concesse in comodato",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Abitazione locata a soggetti in condizioni di vulnerabilità sociale",
        "ratePercent": 0.0005,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione - Condizioni locatario/comodatario: Soggetto in condizioni di vulnerabilita' sociale/emergenza abitativa come definite nel golamento",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
...
//# sourceMappingURL=carpiMO2025.js.map