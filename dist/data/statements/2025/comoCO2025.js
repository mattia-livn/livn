...
exports.imuRatesComoCO2025 = void 0;
exports.imuRatesComoCO2025 = [
    {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D, categorie D/1, D/2, D/3, D/4, D/6, D/7, D/9",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "D/1",
            "D/2",
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D, categoria D/8 con superficie non superiore a 1499 MQ",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "D/8"
        ],
        "officialDescription": "Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Superficie: Non superiore a Mq 1499 MQ",
        "conditions": [
            {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D, categoria D/8 con superficie non inferiore a 1500 MQ",
        "ratePercent": 0.00106,
        "categoryTypes": [
            "D/8"
        ],
        "officialDescription": "Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Superficie: Non inferiore a Mq 1500 MQ",
        "conditions": [
            {
                "description": "L'entità ha categoria D/8",
                "predicate": "['D/8'].includes(entity.category)"
    ...
    },
    {
        ...
        "officialDescription": "Immobili di categoria , C Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /2 Case di cura ed ospedali senza fine di lucro - /5 Scuole e laboratori scientifici - /8 Magazzini sotterranei per depositi di derrate - C/1 Negozi e botteghe - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - C/5 Stabilimenti balneari e di acque curative senza fine di lucro - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
...
//# sourceMappingURL=comoCO2025.js.map