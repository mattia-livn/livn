...
exports.imuRatesMogoroOR2025 = void 0;
exports.imuRatesMogoroOR2025 = [
    {
    ...
    },
    {
        ...
        "ratePercent": 0.00046,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione a canone libero - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    },
    {
        ...
        "officialDescription": "Immobili di categoria A10, C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - A/10 Uffici e studi privati - C/2 Magazzini e locali di deposito - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto",
        "conditions": [
            {
                "description": "L'entità ha categoria A/10 o C/1 o C/3 o C/2 o C/4",
                "predicate": "['A/10','C/1','C/3','C/2','C/4'].includes(entity.category)"
            }
        ]
    }
];
//# sourceMappingURL=mogoroOR2025.js.map