...
exports.imuRatesMonteUranoFM2025 = void 0;
exports.imuRatesMonteUranoFM2025 = [
    {
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D utilizzati da persona giuridica",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "D"
        ],
    ...
    {
        "label": "Fabbricati appartenenti al gruppo catastale D utilizzati da persona fisica",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "D"
        ],
        "officialDescription": "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona fisica di eta' non superio ad anni: 33 - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Immobili di categoria C/1 utilizzati direttamente dal soggetto passivo",
        "ratePercent": 0.0009599999999999999,
        "categoryTypes": [
            "C/1"
        ],
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
    ...
    {
        "label": "Immobili di categoria C/3 utilizzati direttamente dal soggetto passivo",
        "ratePercent": 0.0009599999999999999,
        "categoryTypes": [
            "C/3"
        ],
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
    ...
    {
        "label": "Immobili di categoria A/10, C utilizzati da persona giuridica",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "A/10",
            "C/1",
        ...
        "officialDescription": "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non superio a: 36 - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
...
//# sourceMappingURL=monteUranoFM2025.js.map