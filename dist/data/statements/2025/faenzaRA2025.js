...
exports.imuRatesFaenzaRA2025 = void 0;
exports.imuRatesFaenzaRA2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
                "description": "L'entità ha categoria D/1 o D/8 o D/7",
                "predicate": "['D/1','D/8','D/7'].includes(entity.category)"
            }
        ]
    },
    {
        ...
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
                "description": "L'entità ha categoria C/3 o C/1",
                "predicate": "['C/3','C/1'].includes(entity.category)"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "ratePercent": 0.00073,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Accordi/Patti territoriali per soddisfa particolari esigenze abitative come definiti nel golamento - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Abitazione locata o in comodato con contratto di comodato d'uso gratuito per categorie catastali A/2, A/3, A/4, A/5, A/6, A/7, A/11",
        "ratePercent": 0.00093,
        "categoryTypes": [
            "A/2",
            "A/3",
...
//# sourceMappingURL=faenzaRA2025.js.map