"use strict";
// beregazzoConFigliaroCO2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesBeregazzoConFigliaroCO2025 = void 0;
exports.imuRatesBeregazzoConFigliaroCO2025 = [
    {
    ...
    {
        "label": "Immobili di categoria C/1, C/4, C/5 concessi in comodato a ONLUS o altri enti del terzo settore",
        "ratePercent": 0,
        "categoryTypes": [
            "C/1",
            "C/4",
        ...
        "officialDescription": "Immobili di categoria , C Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /5 Scuole e laboratori scientifici - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili concessi in comodato - Requisiti soggettivi del comodatario: ONLUS o altri enti del terzo setto - Destinazione d'uso: Utilizzati per scopi istituzionali o di pubblica utilita', senza fine di lucro",
        "conditions": [
            {
                "description": "L'entità ha categoria C/1 o C/4 o C/5",
                "predicate": "['C/1','C/4','C/5'].includes(entity.category)"
            }
        ]
    },
    {
...
//# sourceMappingURL=beregazzoConFigliaroCO2025.js.map