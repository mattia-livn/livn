"use strict";
// monterossoAlMareSP2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesMonterossoAlMareSP2025 = void 0;
exports.imuRatesMonterossoAlMareSP2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Locatario/comodatario non titola di propriet� o altro diritto ale di godimento su immobili - Destinazione d'uso: Purch� l'affittuario/comodatario la utilizzi come abitazione principale.",
        "conditions": [
            {
    ...
    },
    {
        ...
        "officialDescription": "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/1 Abitazioni di tipo signorile - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti p gi artistici o storici",
        "conditions": [
            {
                "description": "L'entità ha categoria A/1 o A/8 o A/9",
                "predicate": "['A/1','A/8','A/9'].includes(entity.category)"
    ...
    {
        "label": "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.2",
        "ratePercent": 0.00085,
        "officialDescription": "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.2 - ALLOGGI PER VACANZE E ALTRE STRUTTURE PER REVI SOGGIORNI",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.9",
        "ratePercent": 0.00085,
        "officialDescription": "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.9 - ALTRI ALLOGGI",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
...
//# sourceMappingURL=monterossoAlMareSP2025.js.map