...
exports.imuRatesPiacenzaPC2025 = void 0;
exports.imuRatesPiacenzaPC2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati a disposizione o utilizzati: Immobili concessi in comodato - Requisiti soggettivi del comodatario: ONLUS o altri enti del terzo setto - Destinazione d'uso: Utilizzati per scopi istituzionali o di pubblica utilita', senza fine di lucro - Con contratto gistrato",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : ONLUS o altri enti del terzo setto - Destinazione d'uso: Utilizzati per scopi istituzionali o di pubblica utilita', senza fine di lucro",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    },
    {
        ...
        "officialDescription": "Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile tutti - Destinazione d'uso: Con uso limitato e discontinuo o stagionale, per un periodo complessivo inferio a mesi: 6 - Codice ATECO: 82.30.00 - Organizzazione di convegni e fie",
        "conditions": [
            {
    ...
    {
        "label": "Abitazione locata o in comodato con contratto di locazione ai sensi dell'art. 2, comma 1, della Legge n. 431/1998",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "A/2",
            "A/3",
    ...
    {
        "label": "Abitazione locata o in comodato con contratto di locazione a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998",
        "ratePercent": 0.00049,
        "categoryTypes": [
            "A/2",
            "A/3",
...
//# sourceMappingURL=piacenzaPC2025.js.map