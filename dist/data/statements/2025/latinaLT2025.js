...
exports.imuRatesLatinaLT2025 = void 0;
exports.imuRatesLatinaLT2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/1 Negozi e botteghe - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - C/7 Tettoie chiuse od aperte - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
                "description": "L'entità ha categoria A/10 o C/1 o C/2 o C/3 o C/7",
                "predicate": "['A/10','C/1','C/2','C/3','C/7'].includes(entity.category)"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "ratePercent": 0.00076,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione a studenti ai sensi",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
...
//# sourceMappingURL=latinaLT2025.js.map