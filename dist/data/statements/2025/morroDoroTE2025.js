...
exports.imuRatesMorroDoroTE2025 = void 0;
exports.imuRatesMorroDoroTE2025 = [
    {
    ...
    },
    {
        ...
        "ratePercent": 0,
        "officialDescription": "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: E' p vista l'esenzione per i Ter ni agricoli collocati Dal Foglio n. 1 al Foglio n. 25 collocati sopra la S.S. 150",
        "conditions": [
            {
                "description": "È un terreno agricolo",
                "predicate": "entity.type === 'terreno' && entity.isAgricultural === true"
    ...
    },
    {
        ...
        "officialDescription": "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - A/11 Abitazioni ed alloggi tipici dei luoghi - Utilizzo/Inutilizzo: Con uso limitato e discontinuo o stagionale, per un utilizzo complessivo non superio a mesi: 6 - Collocazione immobile: In una zona specificamente indicata dal comune: Ai sensi L.178/2020 art. 1 c.48 ai sidenti esteri pensionati in gime di convenzione con l'Italia si applica la riduzione del 50% sulla base imponibile dell'IMU",
        "conditions": [
            {
                "description": "L'entità ha categoria A/2 o A/3 o A/4 o A/5 o A/6 o A/7 o A/11",
                "predicate": "['A/2','A/3','A/4','A/5','A/6','A/7','A/11'].includes(entity.category)"
...
//# sourceMappingURL=morroDoroTE2025.js.map