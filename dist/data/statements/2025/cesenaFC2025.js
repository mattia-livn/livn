...
exports.imuRatesCesenaFC2025 = void 0;
exports.imuRatesCesenaFC2025 = [
    {
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/2 Alberghi e pensioni con fine di lucro - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/9 Edifici galleggianti o sospesi assicurati a punti fissi del suolo, ponti privati soggetti a pedaggio - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile tutti - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
                "description": "L'entità ha categoria D/1 o D/2 o D/3 o D/6 o D/7 o D/9",
                "predicate": "['D/1','D/2','D/3','D/6','D/7','D/9'].includes(entity.category)"
            }
        ]
    },
    {
        "label": "Fabbricati appartenenti al gruppo catastale D concessi in comodato a ONLUS o altri enti del terzo settore",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "D"
        ],
        "officialDescription": "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili concessi in comodato - Requisiti soggettivi del comodatario: ONLUS o altri enti del terzo setto - Destinazione d'uso: Utilizzati per scopi istituzionali o di pubblica utilita', senza fine di lucro - Con contratto gistrato *Per contratti di locazione di immobili devono intendersi esclusivamente quelli gistrati ai sensi delle vigenti disposizioni di legge.",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Abitazione locata o in comodato a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998",
        "ratePercent": 0.00086,
    ...
    {
        "label": "Abitazione locata o in comodato con contratto di comodato d'uso gratuito a parenti sino al primo grado",
        "ratePercent": 0.00076,
        "categoryTypes": [
            "A/2",
            "A/3",
    ...
    {
        "label": "Abitazione locata o in comodato con contratto di comodato d'uso gratuito a parenti sino al primo grado in ipotesi diverse",
        "ratePercent": 0.00076,
...
//# sourceMappingURL=cesenaFC2025.js.map