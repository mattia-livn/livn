...
exports.imuRatesTodiPG2025 = void 0;
exports.imuRatesTodiPG2025 = [
    {
    ...
    {
        "label": "Immobili di categoria C, categoria catastale C/4 e C/5",
        "ratePercent": 0.00102,
        "categoryTypes": [
            "C/4",
            "C/5"
    ...
    {
        "label": "Immobili di categoria C, categoria catastale C/1 e C/3 fuori dal centro storico",
        "ratePercent": 0.00102,
        "categoryTypes": [
            "C/1",
            "C/3"
        ],
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: Fuori dal centro storico - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
        "conditions": [
            {
    ...
    {
        "label": "Immobili di categoria C, categoria catastale C/1 e C/3 dentro il centro storico",
        "ratePercent": 0.00102,
        "categoryTypes": [
            "C/1",
            "C/3"
        ],
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: Dentro il centro storico - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo",
        "conditions": [
            {
                "description": "L'entità ha categoria C/1 o C/3",
                "predicate": "['C/1','C/3'].includes(entity.category)"
...
//# sourceMappingURL=todiPG2025.js.map