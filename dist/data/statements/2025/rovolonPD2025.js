...
exports.imuRatesRovolonPD2025 = void 0;
exports.imuRatesRovolonPD2025 = [
    {
    ...
    {
        "label": "Immobili di categoria A/10, C/1, C/2, C/3, C/6, C/7",
        "ratePercent": 0.0008100000000000001,
        "categoryTypes": [
            "A/10",
            "C/1",
        ...
        "officialDescription": "Immobili di categoria A10, , C Categoria catastale: - A/10 Uffici e studi privati - /7 Cappelle ed oratori non destinati all'esercizio pubblico del culto - C/1 Negozi e botteghe - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte",
        "conditions": [
            {
                "description": "L'entità ha categoria A/10 o C/1 o C/2 o C/3 o C/6 o C/7",
                "predicate": "['A/10','C/1','C/2','C/3','C/6','C/7'].includes(entity.category)"
            }
        ]
    },
    {
...
//# sourceMappingURL=rovolonPD2025.js.map