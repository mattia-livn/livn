...
exports.imuRatesBresciaBS2025 = void 0;
exports.imuRatesBresciaBS2025 = [
    {
    ...
    {
        "label": "Fabbricati di proprietà di ONLUS o enti del terzo settore a disposizione",
        "ratePercent": 0.00109,
        "categoryTypes": [
            "D"
        ],
    ...
    {
        "label": "Fabbricati di proprietà di ONLUS o enti del terzo settore utilizzati direttamente",
        "ratePercent": 0.00109,
        "categoryTypes": [
            "D"
        ],
    ...
    {
        "label": "Terreni agricoli ricadenti in determinate aree",
        "ratePercent": 0,
        "officialDescription": "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: Individuata dall'ordinanza sindacale n. 208 del 20.11.2024",
        "conditions": [
            {
                "description": "È un terreno agricolo",
                "predicate": "entity.type === 'terreno' && entity.isAgricultural === true"
    ...
    {
        "label": "Abitazione locata o in comodato ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i.",
        "ratePercent": 0.00088,
    ...
    {
        "label": "Abitazione locata o in comodato ai sensi dell'art. 5, comma 1, della Legge n. 431/1998 e s.m.i.",
        "ratePercent": 0.00088,
    ...
    {
        "label": "Abitazione locata o in comodato ai sensi dell'art. 5, comma 3, della Legge n. 431/1998 e s.m.i.",
        "ratePercent": 0.00088,
    ...
    },
    {
        ...
        "ratePercent": 0.00066,
        "officialDescription": "Fabbricati di civile abitazione destinati ad alloggi sociali non adibiti ad abitazione principale per il periodo di espletamento",
        "conditions": [
            {
                "description": "L'entità è un fabbricato",
                "predicate": "entity.type === 'fabbricato'"
...
//# sourceMappingURL=bresciaBS2025.js.map