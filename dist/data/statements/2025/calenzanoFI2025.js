...
exports.imuRatesCalenzanoFI2025 = void 0;
exports.imuRatesCalenzanoFI2025 = [
    {
    ...
    {
        "label": "Abitazione locata o in comodato, tipo contratto: Locazione, categorie catastali A/2, A/3, A/4, A/5, A/6, A/7",
        "ratePercent": 0.0006,
        "categoryTypes": [
            "A/2",
            "A/3",
    ...
    {
        "label": "Immobili di categoria C, categoria catastale C/2 Magazzini e locali di deposito",
        "ratePercent": 0.0007,
        "categoryTypes": [
            "C/2"
        ],
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - Superficie: Non superio a Mq 30 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
        "conditions": [
            {
    ...
    {
        "label": "Abitazione locata o in comodato, tipo contratto: Locazione, categorie catastali A/1, A/8, A/9",
        "ratePercent": 0.00075,
        "categoryTypes": [
            "A/1",
            "A/8",
        ...
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: - A/1 Abitazioni di tipo signorile - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti p gi artistici o storici",
        "conditions": [
            {
                "description": "L'entità ha categoria A/1 o A/8 o A/9",
                "predicate": "['A/1','A/8','A/9'].includes(entity.category)"
...
//# sourceMappingURL=calenzanoFI2025.js.map