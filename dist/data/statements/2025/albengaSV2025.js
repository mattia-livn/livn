...
exports.imuRatesAlbengaSV2025 = void 0;
exports.imuRatesAlbengaSV2025 = [
    {
    ...
    {
        "label": "Immobili di categoria A10 e altre specifiche categorie",
        "ratePercent": 0.001035,
        "categoryTypes": [
            "A/10"
        ],
        "officialDescription": "Immobili di categoria A10, Categoria catastale: - /6 iblioteche, pinacoteche, musei, gallerie, accademie che non hanno sede in edifici della categoria A/9 - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /8 Magazzini sotterranei per depositi di derrate - /2 Case di cura ed ospedali senza fine di lucro - A/10 Uffici e studi privati - /5 Scuole e laboratori scientifici - /4 Uffici pubblici - /7 Cappelle ed oratori non destinati all'esercizio pubblico del culto - /3 Prigioni e riformatori",
        "conditions": [
            {
    ...
    {
        "label": "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2",
        "ratePercent": 0.001035,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2,",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Immobili di categoria C/3, C/4, C/5",
        "ratePercent": 0.0009599999999999999,
        "categoryTypes": [
            "C/3",
            "C/4",
...
//# sourceMappingURL=albengaSV2025.js.map