"use strict";
// montespertoliFI2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesMontespertoliFI2025 = void 0;
exports.imuRatesMontespertoliFI2025 = [
    {
    ...
    {
        "label": "Fabbricati a disposizione o utilizzati: Immobili a disposizione",
        "ratePercent": 0.00106,
        "categoryTypes": [
            "D"
        ],
    ...
    },
    {
        ...
        "officialDescription": "Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 0",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati: Immobili a disposizione",
        "ratePercent": 0.00106,
        "categoryTypes": [
            "A10",
            "C"
    ...
    },
    {
        ...
        "officialDescription": "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 0",
        "conditions": [
            {
                "description": "L'entità ha categoria A10",
                "predicate": "['A10'].includes(entity.category)"
    ...
    },
    {
        ...
        "ratePercent": 0.0009599999999999999,
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019",
        "conditions": [
            {
                "description": "Condizione applicabile in base al regolamento comunale",
                "predicate": "true // Da specificare in base alle condizioni locali"
    ...
    {
        "label": "Immobili di categoria C - Categoria catastale: C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo",
        "ratePercent": 0.00086,
        "categoryTypes": [
            "C/3"
        ],
...
//# sourceMappingURL=montespertoliFI2025.js.map