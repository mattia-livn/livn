"use strict";
// roccastradaGR2025.ts
// Migrato automaticamente dal formato legacy
Object.defineProperty(exports, "__esModule", { value: true });
exports.imuRatesRoccastradaGR2025 = void 0;
exports.imuRatesRoccastradaGR2025 = [
    {
    ...
    {
        "label": "Immobili di categoria C, categoria C/1 e C/3",
        "ratePercent": 0.00086,
        "categoryTypes": [
            "C/1",
            "C/3"
    ...
    },
    {
        ...
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
        "conditions": [
            {
    ...
    {
        "label": "Abitazione locata o in comodato, tipo contratto: Comodato d'uso gratuito con contratto registrato",
        "ratePercent": 0.00043,
        "categoryTypes": [
            "A/2",
            "A/3",
    ...
    {
        "label": "Abitazione locata o in comodato, tipo contratto: Accordi/Patti territoriali",
    ...
    {
        "label": "Abitazione locata o in comodato, tipo contratto: Accordi/Patti territoriali con destinazione d'uso abitazione principale",
        "ratePercent": 0.0006450000000000001,
        "categoryTypes": [
            "A/2",
            "A/3",
            "A/4",
        ...
        "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Accordi/Patti territoriali per soddisfa particolari esigenze abitative come definiti nel golamento Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
        "conditions": [
            {
                "description": "L'entità ha categoria A/2 o A/3 o A/4 o A/5 o A/6 o A/7",
                "predicate": "['A/2','A/3','A/4','A/5','A/6','A/7'].includes(entity.category)"
...
//# sourceMappingURL=roccastradaGR2025.js.map