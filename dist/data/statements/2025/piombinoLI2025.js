...
exports.imuRatesPiombinoLI2025 = void 0;
exports.imuRatesPiombinoLI2025 = [
    {
    ...
    {
        "label": "Aree fabbricabili situate in determinate zone con vincolo per esproprio",
        "ratePercent": 0.0001,
        "officialDescription": "A e Fabbricabili - Situate in determinate zone: Con apposto vincolo p ordinato all'esproprio da parte del comune",
        "conditions": [
            {
                "description": "Il terreno è edificabile secondo PRG o catasto",
                "predicate": "entity.isBuildable === true"
    ...
    {
        "label": "Immobili di categoria C/1 e C/3",
    ...
    {
        "label": "Immobili di categoria A/10 e altri specifici usi",
        "ratePercent": 0.00091,
        "categoryTypes": [
            "A/10"
        ],
        "officialDescription": "Immobili di categoria A10, Categoria catastale: - A/10 Uffici e studi privati - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme",
        "conditions": [
            {
    ...
    {
        "label": "Immobili di categoria C/2, C/4, C/5, C/6, C/7 senza fine di lucro",
        "ratePercent": 0.00091,
        "categoryTypes": [
            "C/2",
            "C/4",
        ...
        "officialDescription": "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - C/5 Stabilimenti balneari e di acque curative senza fine di lucro - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte",
        "conditions": [
            {
                "description": "L'entità ha categoria C/2 o C/4 o C/5 o C/6 o C/7",
                "predicate": "['C/2','C/4','C/5','C/6','C/7'].includes(entity.category)"
            }
        ]
    },
    {
...
//# sourceMappingURL=piombinoLI2025.js.map