...
exports.exampleProperties = void 0;
exports.exampleBatchProcessing = exampleBatchProcessing;
exports.testQuestionGenerator = testQuestionGenerator;
// exampleUsage.ts
...
exports.exampleProperties = exampleProperties;
// Test del generatore
function testQuestionGenerator() {
    console.log('=== TEST GENERATORE DOMANDE IMU TORINO 2025 ===\n');
    const generator = new questionGenerator_1.TorinIMUQuestionGenerator();
...
function exampleBatchProcessing() {
    const questionsMap = (0, questionGenerator_1.generateQuestionsForProperties)(exampleProperties);
    console.log(`\n=== ELABORAZIONE BATCH ===`);
