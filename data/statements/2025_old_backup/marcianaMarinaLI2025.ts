...
export const imuRatesMarcianaMarinaLI2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.76,
    categoryTypes: [],
    context: "Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale."
  ,
