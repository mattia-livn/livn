...
export const imuRatesBrendolaVI2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D (D/1, D/7, D/8) utilizzati direttamente dal soggetto passivo",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile tutti - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.76,
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D (D/5) istituto di credito, cambio e assicurazione con fine di lucro",
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D (D/1, D/7, D/8) locati o concessi in comodato",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.94,
    categoryTypes: ["D/1","D/7","D/8"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Altri fabbricati di categoria C (C/1) utilizzati direttamente dal soggetto passivo",
  ...
  {
    condition: "Altri fabbricati di categoria C (C/1) a disposizione",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili a disposizione",
    ratePercent: 1.06,
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
