...
export const imuRatesAlbisolaSuperioreSV2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferiore a mesi, specifica: 8",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferio a mesi, specifica : 8",
    ratePercent: 1.06,
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati - Destinazione d'uso: Utilizzato per attività produttiva e/o commerciale o per l'esercizio di arti e professioni",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.96,
