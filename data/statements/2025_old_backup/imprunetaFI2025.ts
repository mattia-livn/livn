...
export const imuRatesImprunetaFI2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali n.: fogli catastali: 36 e 37",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 36 e 37",
    ratePercent: 1.06,
    categoryTypes: [],
    context: "Ricadenti nei fogli catastali n.: fogli catastali: 36 e 37",
    zone: "Fogli catastali: 36 e 37"
  ,
    requiredParameters: {
      required: [],
      conditional: [
