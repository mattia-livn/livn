...
export const imuRatesNuvolentoBS2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali n. 16 e 17",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 16 e 17",
    ratePercent: 0.76
    categoryTypes: []
    zone: "fogli catastali: 16 e 17"
  ,
    requiredParameters: {
      required: [],
      conditional: [
