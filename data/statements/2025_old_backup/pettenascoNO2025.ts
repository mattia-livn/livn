...
export const imuRatesPettenascoNO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale",
    ratePercent: 0.95,
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di comodato d'uso gratuito, condizioni diverse",
