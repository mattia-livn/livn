...
export const imuRatesRoccaSanCascianoFC2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Abitazione locata o in comodato, tipo contratto: Comodato d'uso gratuito, categorie catastali A/2, A/3, A/4",
  ...
  {
    condition: "Immobili di categoria A10, categorie catastali A/10, B/1, B/2, B/3, B/4, B/5, B/6, B/7, B/8",
    ...
    ratePercent: 0.88
    categoryTypes: ["A/10","B/1","B/2","B/3","B/4","B/5","B/6","B/7","B/8"]
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C, categorie catastali C/1, C/2, C/3",
