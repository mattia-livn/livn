...
export const imuRatesCarcareSV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 0.61
    categoryTypes: ["A/2","A/3","A/4","A/7"]
    context: "Con contratto registrato, purché l'affittuario/comodatario la utilizzi come abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
