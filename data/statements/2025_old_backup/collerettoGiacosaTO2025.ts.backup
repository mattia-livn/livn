...
export const imuRatesCollerettoGiacosaTO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali n. 1",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 1",
    ratePercent: 0
    categoryTypes: []
    zone: "fogli catastali: 1"
  ,
    requiredParameters: {
      required: [],
      conditional: [
