...
export const imuRatesVoghieraFE2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/8, codice ATECO: 47.2",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 47.2 - COMMERCIO AL D TAGLIO DI PRODOTTI ALIMENTARI, EVANDE E TA ACCO IN ESERCIZI SPECIALIZZATI",
    ratePercent: 0.76,
    categoryTypes: ["D/8"],
    context: "Codice ATECO: 47.2"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/8, codice ATECO: 47.11",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 47.11 - Commercio al dettaglio in esercizi non specializzati con p valenza di prodotti alimentari e bevande",
    ratePercent: 0.76,
    categoryTypes: ["D/8"],
    context: "Codice ATECO: 47.11"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/8, codice ATECO: 56.3",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 56.3 - AR E ALTRI ESERCIZI SIMILI SENZA CUCINA",
    ratePercent: 0.76,
    categoryTypes: ["D/8"],
    context: "Codice ATECO: 56.3"
  ,
    requiredParameters: {
      required: [
      {
