...
export const imuRatesBriennoCO2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/4 Abitazioni di tipo popola - A/6 Abitazioni di tipo rurale - Utilizzo/Inutilizzo: Privi di ogni ar do, sprovvisti di utenze di fornitura attive di acqua, luce e gas",
    ratePercent: 0.53,
    categoryTypes: ["A/4","A/6"]
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.53,
    categoryTypes: ["C/2"],
    zone: "ReescCunsceria, ConceriaCarpino, Via CarpinaSalmajou, Salmaju, SolmajuColzagoGiumanello, GiumanellQuarolaSomainaPalainaGomba, GombettaSciogn, ScieugnRisceePian d'erba FeePraeeRoda"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
    ...
    },
  {
    ...
    context: "Con contratto gistrato"
  ,
    requiredParameters: {
      required: [
      {
