...
export const imuRatesPoggioRuscoMN2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D di nuova costruzione e ampliamenti",
    details: "ALIQUOTA FABBRICATI CATEGORIA CATASTALE D DI NUOVA COSTRUZIONE E AMPLIAMENTI: 1,06%",
    ratePercent: 1.06,
    categoryTypes: ["D"],
    context: "Nuova costruzione e ampliamenti"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
