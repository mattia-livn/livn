...
export const imuRatesSanGiovanniInPersicetoBO2025: ImuRateEntry[] = [
  ...
  ,
    requiredParameters: {
            ...
            "commune": "sanGiovanniInPersiceto"
      },
  {
    ...
    },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale - Destinazione d'uso: Purch� l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.82,
    categoryTypes: []
  ,
    requiredParameters: {
