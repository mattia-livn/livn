...
export const imuRatesTrenzanoBS2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Con contratto registrato, condizioni locatario/comodatario: parenti sino al primo grado, destinazione d'uso: purché l'affittuario/comodatario la utilizzi come abitazione principale, limitatamente ad un solo immobile."
  ,
    requiredParameters: {
      required: [
      {
