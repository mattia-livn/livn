...
export const imuRatesSanBiagioDiCallaltaTV2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria speciale (Collegi, case di cura, prigioni, uffici pubblici, scuole, biblioteche, cappelle, magazzini)",
  ...
  {
    condition: "Immobili di categoria A10, C (Uffici, negozi, laboratori, fabbricati sportivi, stabilimenti balneari)",
