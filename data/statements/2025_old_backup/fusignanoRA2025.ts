...
export const imuRatesFusignanoRA2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    ratePercent: 0.53,
    categoryTypes: [],
    zone: "vincolo preordinato all'esproprio"
  ,
    requiredParameters: {
      required: [],
      conditional: [
      ...
      },
  {
    ...
    ratePercent: 0.1,
    categoryTypes: [],
    zone: "centro storico durante interventi di recupero"
  ,
    requiredParameters: {
      required: [],
      conditional: [
  ...
  {
    condition: "Abitazione a disposizione, non locate e non concesse in comodato, fabbricati inagibili a seguito di calamità naturali",
