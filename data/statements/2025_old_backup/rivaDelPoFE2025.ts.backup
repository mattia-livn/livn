...
export const imuRatesRivaDelPoFE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/1 Negozi e botteghe, superficie non superiore a 100 mq",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 100 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.86
    categoryTypes: ["C/1"]
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/3 Laboratori per arti e mestieri, superficie non superiore a 100 mq",
    details: "Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri - Superficie: Non superio a Mq 100 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.86
    categoryTypes: ["C/3"]
    context: "Superficie non superiore a 100 mq"
  ,
