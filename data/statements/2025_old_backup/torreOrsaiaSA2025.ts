...
export const imuRatesTorreOrsaiaSA2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini",
    ratePercent: 0.91,
    categoryTypes: ["A/3","A/4","A/6","A/7"]
  ,
    requiredParameters: {
      required: [
      {
