...
export const imuRatesRomagnanoSesiaNO2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali esclusi",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: ESCLUSI I FOGLI DAL 1 AL 25, 28, 29 DAL 31 AL 34, 36 E 38",
    ratePercent: 0,
    categoryTypes: [],
    context: "Esclusi i fogli dal 1 al 25, 28, 29 dal 31 al 34, 36 e 38"
  ,
    requiredParameters: {
      required: [],
      conditional: [
