...
export const imuRatesSorgaVR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: A/7 Abitazioni in villini",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: - A/7 Abitazioni in villini",
    ratePercent: 1.05
    categoryTypes: ["A/7"]
