...
export const imuRatesMantelloSO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D utilizzati per la produzione di energia elettrica",
    details: "Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Codice ATECO: 35.11.00 - Produzione di energia elettrica",
    ratePercent: 1.06
    categoryTypes: ["D/1"]
    context: "Produzione di energia elettrica"
  ,
    requiredParameters: {
      required: [
      {
