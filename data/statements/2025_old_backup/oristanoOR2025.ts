...
export const imuRatesOristanoOR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto registrato - Condizioni locatario/comodatario: Parenti - Sino al secondo grado in linea retta",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta - Destinazione d'uso: Purch� l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.86,
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. - Durata del contratto di durata non inferiore a 36 mesi",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. - Durata del contratto di durata non inferio a mesi, specifica : 36 - Destinazione d'uso: Purch� l'affittuario/comodatario la",
    ratePercent: 0.3,
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998 e s.m.i. - Durata del contratto di durata non inferiore a 6 mesi",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998 e s.m.i. - Durata del contratto di durata non inferio a mesi, specifica : 6",
    ratePercent: 0.3,
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 5, comma 1, della Legge n. 431/1998 e s.m.i. - Durata del contratto di durata non inferiore a 1 mese",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 5, comma 1, della Legge n. 431/1998 e s.m.i. - Durata del contratto di durata non inferio a mesi, specifica : 1",
    ratePercent: 0.3,
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo",
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Immobili non produttivi di ddito fondiario art. 43 T.U.I.R.",
    ratePercent: 0.91,
    categoryTypes: ["A10","C"]
  ,
    requiredParameters: {
