...
export const imuRatesPrignanoSullaSecchiaMO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    zone: "Il comodante e comodatario devono risiede nel Comune di Prignano sulla Secchia"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - Con contratto gistrato",
    ratePercent: 0.485
