...
export const imuRatesAbanoTermePD2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato a soggetto in condizioni di vulnerabilità sociale/emergenza abitativa",
    ...
    ratePercent: 0,
    categoryTypes: [],
    context: "Tipo contratto: Locazione - Condizioni locatario/comodatario: Soggetto in condizioni di vulnerabilità sociale/emergenza abitativa come definite nel regolamento"
  ,
    requiredParameters: {
      required: [
      {
