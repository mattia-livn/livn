...
export const imuRatesPadriaSS2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C - Laboratori per arti e mestieri",
    ...
    },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola",
    ratePercent: 0.82,
