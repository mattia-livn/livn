...
export const imuRatesCastelnuovoBormidaAL2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 6 - 7 - 8 - 9 - 13 - 14",
    ratePercent: 0,
    categoryTypes: [],
    zone: "fogli catastali: 6 - 7 - 8 - 9 - 13 - 14"
  ,
    requiredParameters: {
      required: [],
      conditional: [
