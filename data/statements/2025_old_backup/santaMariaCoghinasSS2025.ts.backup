...
export const imuRatesSantaMariaCoghinasSS2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie catastali D/1, D/7, D/8 in zone soggette ad un alto tasso di abbandono di attività economico-commerciale",
    details: "Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Collocazione immobile: In zone soggette ad un alto tasso di abbandono di attivita' economico-commerciale: Zona artigianale P.I.P.",
    ratePercent: 0.85
    categoryTypes: ["D/1","D/7","D/8"]
    context: "In zone soggette ad un alto tasso di abbandono di attività economico-commerciale"
    zone: "Zona artigianale P.I.P."
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "- Tipologia: Diverse da sidenziali - Situate in determinate zone: Zona artigianale P.I.P.",
    ratePercent: 1.06
    categoryTypes: []
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D, categoria catastale /2 Case di cura ed ospedali senza fine di lucro",
    details: "Immobili di categoria Categoria catastale: - /2 Case di cura ed ospedali senza fine di lucro",
    ratePercent: 1.06
    categoryTypes: ["/2"]
    context: "Case di cura ed ospedali senza fine di lucro"
  ,
    requiredParameters: {
            "required": [
                  {
