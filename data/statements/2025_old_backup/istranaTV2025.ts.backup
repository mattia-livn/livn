...
export const imuRatesIstranaTV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Comodato d'uso gratuito, contratto registrato, condizioni specifiche"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato e condizioni specifiche",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale. - Limitatamente ad un solo immobile.",
    ratePercent: 0.7
    categoryTypes: []
    context: "Comodato d'uso gratuito, contratto registrato, condizioni specifiche"
  ,
