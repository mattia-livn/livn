...
export const imuRatesCetonaSI2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Immobili di categoria A/10, C Categoria catastale: - A/10 Uffici e studi privati",
    ratePercent: 0.98,
    categoryTypes: ["A/10"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria /2 Case di cura ed ospedali senza fine di lucro",
