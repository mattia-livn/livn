...
export const imuRatesBoissanoSV2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione destinata a struttura turistico-ricettiva - Attivit� condotta in forma imp nditoriale",
    ratePercent: 0.8,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    ratePercent: 0.8,
    categoryTypes: ["A/3","A/4","A/5","A/6","A/7"],
