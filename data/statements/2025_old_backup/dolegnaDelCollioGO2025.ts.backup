...
export const imuRatesDolegnaDelCollioGO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Immobili diversi da abitazione principale e gruppo D"
  ,
    requiredParameters: {
            "required": [
                  {
      ...
      },
  {
    ...
    context: "Immobili produttivi/commerciali"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
