...
export const imuRatesLivinallongoDelColDiLanaBL2025: ImuRateEntry[] = [
  {
  ...
  ,
    requiredParameters: {
            ...
            "commune": "livinallongoDelColDiLana"
      },
  {
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Codice ATECO: 35.1 - PRODUZIONE, TRASMISSIONE E DISTRI UZIONE DI ENERGIA EL TRICA",
    ratePercent: 1.06,
    categoryTypes: ["D/1"],
    context: "Codice ATECO: 35.1 - PRODUZIONE, TRASMISSIONE E DISTRIBUZIONE DI ENERGIA ELETTRICA"
  ,
    requiredParameters: {
      required: [
      {
