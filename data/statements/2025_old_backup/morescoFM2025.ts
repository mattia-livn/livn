...
export const imuRatesMorescoFM2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria A/10, C dentro il centro storico",
    details: "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: Dentro il centro storico",
    ratePercent: 0.56,
  ...
  {
    condition: "Immobili di categoria A/10, C fuori dal centro storico",
    details: "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: Fuori dal centro storico",
    ratePercent: 0.86,
    categoryTypes: ["A/10","C/1","C/3"],
    context: "Fuori dal centro storico",
    zone: "Fuori centro storico"
  ,
    requiredParameters: {
      required: [
      {
