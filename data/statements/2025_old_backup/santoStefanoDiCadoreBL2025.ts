...
export const imuRatesSantoStefanoDiCadoreBL2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    context: "Categoria catastale: - D/1 Opifici - D/2 Alberghi e pensioni con fine di lucro"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
