...
export const imuRatesCastelGiorgioTR2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    context: "Uffici e studi privati, Negozi e botteghe, Laboratori per arti e mestieri"
  ,
    requiredParameters: {
      required: [
      {
