...
export const imuRatesAndoraSV2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati - Tipologia di attivit�: Microimp se",
    ratePercent: 0.9,
