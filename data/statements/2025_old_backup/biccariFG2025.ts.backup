...
export const imuRatesBiccariFG2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- Tipo contratto: Locazione ai sensi dell'art. 5, comma 3, della Legge n. 431/1998 e s.m.i.",
    ratePercent: 0.765
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferiore a mesi, specifica: 6",
