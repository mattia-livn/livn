...
export const imuRatesTerranuovaBraccioliniAR2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    ratePercent: 0.76,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"],
    context: "Condizioni locatario/comodatario: parenti sino al primo grado, ipotesi diverse"
  ,
    requiredParameters: {
      required: [
      {
