...
export const imuRatesMottolaTA2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    ratePercent: 0.76,
    categoryTypes: [],
    context: "Comodato d'uso gratuito, Parenti sino al primo grado, Destinazione d'uso come abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
