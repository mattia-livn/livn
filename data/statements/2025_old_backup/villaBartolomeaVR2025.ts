...
export const imuRatesVillaBartolomeaVR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati per attività produttiva e/o commerciale o per l'esercizio di arti e professioni",
