...
export const imuRatesRosignanoMarittimoLI2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Parenti - Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019",
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione - Condizioni locatario/comodatario: Soggetto in condizioni di vulnerabilità sociale/emergenza abitativa",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Condizioni locatario/comodatario: Soggetto in condizioni di vulnerabilita' sociale/emergenza abitativa come definite nel golamento",
    ratePercent: 0,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Ulteriori condizioni non rinvenibili tra quelle proposte nella p sente schermata",
    ratePercent: 1.13,
    categoryTypes: []
  ,
    requiredParameters: {
