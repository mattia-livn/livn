...
export const imuRatesCastiglioneChiavareseGE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 0.7
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"]
    context: "Durata del contratto non inferiore a 12 mesi, con contratto registrato"
  ,
    requiredParameters: {
      required: [
      {
