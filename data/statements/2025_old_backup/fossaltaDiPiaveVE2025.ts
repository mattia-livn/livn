...
export const imuRatesFossaltaDiPiaveVE2025: ImuRateEntry[] = [
  ...
  {
    condition: "Terreni agricoli in determinate aree: Area golenale",
    details: "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: A a golenale",
    ratePercent: 0.4,
    categoryTypes: [],
    zone: "Area golenale"
  ,
      ...
      },
  {
    ...
    ratePercent: 0.45,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/11"],
    zone: "Area golenale"
  ,
    requiredParameters: {
      required: [
