...
export const imuRatesRivalbaTO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria catastale C/7 Cappelle ed oratori non destinati all'esercizio pubblico del culto",
    details: "Immobili di categoria Categoria catastale: - /7 Cappelle ed oratori non destinati all'esercizio pubblico del culto",
    ratePercent: 0.76,
    categoryTypes: ["C/7"]
  ,
    requiredParameters: {
