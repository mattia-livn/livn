...
export const imuRatesLazzateMB2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe con superficie non superiore a 100 mq utilizzati direttamente dal soggetto passivo",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 100 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.86,
    categoryTypes: ["C/1"],
  ...
  {
    condition: "Immobili di categoria C/3 Laboratori per arti e mestieri con superficie non superiore a 200 mq utilizzati direttamente dal soggetto passivo",
    details: "Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri - Superficie: Non superio a Mq 200 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.86,
    categoryTypes: ["C/3"]
  ,
    requiredParameters: {
