...
export const imuRatesBaschiTR2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del locatario, comodatario o soggetto passivo utilizzato : ONLUS o altri enti del terzo setto",
    ratePercent: 0.76,
    categoryTypes: [],
