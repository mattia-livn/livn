...
export const imuRatesArzignanoVI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili a disposizione",
  ...
  {
    condition: "Immobili di categoria C - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo",
