...
export const imuRatesGuilmiCH2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "esercizi commerciali e artigianali situati in zone p cluse al traffico a causa dello svolgimento di lavori per la alizzazione di ope pubbliche che si protraggono per olt sei mesi art. 1, comma 86, della legge n. 549 del 1995 con aliquota agevolata applicata: 0,55%.",
    ratePercent: 0.55,
    categoryTypes: [],
