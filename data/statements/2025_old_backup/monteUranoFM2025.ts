...
export const imuRatesMonteUranoFM2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D utilizzati da persona giuridica",
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D utilizzati da persona fisica",
  ...
  {
    condition: "Immobili di categoria C/1 utilizzati direttamente dal soggetto passivo",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.96,
    categoryTypes: ["C/1"],
    context: "Utilizzato per attività produttiva e/o commerciale o per l'esercizio di arti e professioni"
  ,
  ...
  {
    condition: "Immobili di categoria C/3 utilizzati direttamente dal soggetto passivo",
    details: "Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.96,
    categoryTypes: ["C/3"],
    context: "Utilizzato per attività produttiva e/o commerciale o per l'esercizio di arti e professioni"
  ,
  ...
  {
    condition: "Abitazione locata ai sensi dell'art. 2, comma 3, della Legge n.431/1998",
  ...
  {
    condition: "Immobili di categoria A/10, C utilizzati da persona giuridica",
