...
export const imuRatesMonteverdiMarittimoPI2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Categoria catastale: - D/1 Opifici - D/5 Istituto di credito, cambio e assicurazione con fine di lucro - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attività industriale e non suscettibili di destinazione diversa senza radicali trasformazioni"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
      ...
      },
  {
    ...
    ratePercent: 0.76
    categoryTypes: []
    context: "Tipo contratto: Locazione - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale."
  ,
    requiredParameters: {
      required: [
      {
