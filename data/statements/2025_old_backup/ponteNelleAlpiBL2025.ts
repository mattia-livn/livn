...
export const imuRatesPonteNelleAlpiBL2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato, destinazione d'uso abitazione principale",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.96,
    categoryTypes: []
  ,
    requiredParameters: {
