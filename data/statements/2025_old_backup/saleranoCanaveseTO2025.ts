...
export const imuRatesSaleranoCanaveseTO2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "- Utilizzo: Ter ni agricoli condotti da CD e IAP e Societa' agricole non posseduti - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 8-12-13",
    ratePercent: 0,
    categoryTypes: [],
    context: "Condotti da CD e IAP e Società agricole non posseduti",
    zone: "Fogli catastali: 8-12-13"
  ,
    requiredParameters: {
      required: [],
      conditional: [
