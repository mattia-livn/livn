...
export const imuRatesSanDamianoDastiAT2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/2 Alberghi e pensioni con fine di lucro - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili a disposizione",
    ratePercent: 1.06,
    categoryTypes: ["D/1","D/2","D/3"],
    context: "a disposizione"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D/5 e D/8",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/5 Istituto di c dito, cambio e assicurazione con fine di lucro - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 1.06,
  ...
  {
    condition: "Aree fabbricabili diverse da residenziali",
    details: "A e Fabbricabili - Tipologia: Diverse da sidenziali",
    ratePercent: 1.06,
    categoryTypes: [],
