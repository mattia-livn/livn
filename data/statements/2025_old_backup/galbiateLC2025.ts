...
export const imuRatesGalbiateLC2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Parenti - Sino al secondo grado in linea retta e collaterale - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
      ...
      },
  {
    ...
    details: "Abitazione utilizzata direttamente dal soggetto passivo",
    ratePercent: 1.06,
    categoryTypes: []
  ,
    requiredParameters: {
