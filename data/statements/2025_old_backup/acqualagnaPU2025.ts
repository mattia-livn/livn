...
export const imuRatesAcqualagnaPU2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/5 Istituto di credito, cambio e assicurazione con fine di lucro",
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo, destinazione d'uso: Impianti idroelettrici",
    details: "- Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Impianti idroelettrici",
    ratePercent: 1.06,
    categoryTypes: ["D"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo, destinazione d'uso: Impianti eolici e fotovoltaici con potenza superiore a 200 kW",
    details: "- Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Impianti eolici e fotovoltaici - Potenza impianti produzione energia, superio a kW: 200",
    ratePercent: 1.06,
    categoryTypes: ["D"]
  ,
    requiredParameters: {
