...
export const imuRatesLocateVaresinoCO2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato, utilizzata come abitazione principale, categorie catastali A/2, A/3, A/4, A/5, A/6, A/7, A/11",
    ...
    context: "Comodato d'uso gratuito, utilizzata come abitazione principale, limitatamente ad un solo immobile"
  ,
    requiredParameters: {
      required: [
      {
