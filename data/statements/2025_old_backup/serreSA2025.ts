...
export const imuRatesSerreSA2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli coltivati ricadenti nei fogli catastali n. 35, 36 e 37",
    details: "- Utilizzo: Coltivati - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 35, 36 E 37",
    ratePercent: 0.5,
    categoryTypes: [],
    context: "Coltivati",
    zone: "Fogli catastali: 35, 36, 37"
  ,
    requiredParameters: {
      required: [],
      conditional: [
