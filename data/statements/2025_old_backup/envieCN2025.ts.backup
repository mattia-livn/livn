...
export const imuRatesEnvieCN2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 1 - 2 - 3 - 13 - 14 - 15 - 16 - 17 - 18",
    ratePercent: 0
    categoryTypes: []
    zone: "fogli catastali: 1 - 2 - 3 - 13 - 14 - 15 - 16 - 17 - 18"
  ,
    requiredParameters: {
      required: [],
      conditional: [
  ...
  {
    condition: "Abitazione locata o in comodato senza contratto registrato",
