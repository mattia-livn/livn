...
export const imuRatesAmandolaFM2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Collocazione immobile: In una zona specificamente indicata dal comune: Fabbricati concessi in locazione in centro storico ex zona rossa e vie limitrofe indicate nella delibera di C.C. nr. 64 del 29/12/2023",
    ratePercent: 0.76
    categoryTypes: []
    context: "Locazione in centro storico ex zona rossa e vie limitrofe"
    zone: "Centro storico ex zona rossa e vie limitrofe"
  ,
    requiredParameters: {
      required: [
      {
