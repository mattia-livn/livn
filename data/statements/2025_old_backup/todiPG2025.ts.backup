...
export const imuRatesTodiPG2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/4 e C/5",
    details: "Immobili di categoria C Categoria catastale: - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - C/5 Stabilimenti balneari e di acque curative senza fine di lucro",
    ratePercent: 1.02
    categoryTypes: ["C/4","C/5"]
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/1 e C/3 fuori dal centro storico",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: Fuori dal centro storico - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 1.02
    categoryTypes: ["C/1","C/3"]
    context: "Fuori dal centro storico"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/1 e C/3 dentro il centro storico",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: Dentro il centro storico - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo",
    ratePercent: 1.02
    categoryTypes: ["C/1","C/3"]
    context: "Dentro il centro storico"
  ,
    requiredParameters: {
      required: [
      {
