...
export const imuRatesPessanoConBornagoMI2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria C utilizzati direttamente dal soggetto passivo per attività produttiva e/o commerciale o per l'esercizio di arti e professioni",
  ...
  {
    condition: "Abitazione locata a studenti con contratto di durata non inferiore a 6 mesi",
