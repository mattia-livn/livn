...
export const imuRatesAssisiPG2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- Tipologia: Diverse da residenziali - Situate in determinate zone: \"PIP\" - piano insediamento produttivo di Rivotorto",
    ratePercent: 0.96
    categoryTypes: []
    zone: "PIP - piano insediamento produttivo di Rivotorto"
  ,
    requiredParameters: {
            "required": [
                  {
