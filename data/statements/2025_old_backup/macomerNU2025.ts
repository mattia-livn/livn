...
export const imuRatesMacomerNU2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    zone: "Zone interessate da lavori pubblici"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
      ...
      },
  {
    ...
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D - Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al terzo grado in linea tta e collaterale",
    ratePercent: 0.71,
    categoryTypes: [],
