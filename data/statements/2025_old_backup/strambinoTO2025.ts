...
export const imuRatesStrambinoTO2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali n.: fg. 31 e fg 36",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: fg. 31 e fg 36",
    ratePercent: 0,
    categoryTypes: [],
    zone: "fogli catastali: fg. 31 e fg 36"
  ,
    requiredParameters: {
      required: [],
      conditional: [
