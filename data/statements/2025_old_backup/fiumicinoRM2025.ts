...
export const imuRatesFiumicinoRM2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    context: "Contratti di Accordi/Patti territoriali"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.1,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"],
    context: "Comodato d'uso gratuito con ISEE non superiore a € 11000"
  ,
    requiredParameters: {
      required: [
      {
