...
export const imuRatesGreveInChiantiFI2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto",
    ratePercent: 0.76,
    categoryTypes: ["D/3"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D Abitazione locata o in comodato - Tipo contratto: Locazione a canone libero - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.88,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    ratePercent: 1,
    categoryTypes: ["/1","/2","/3","/4","/5","/6","/7","/8","C/2","C/6","C/7"]
  ,
    requiredParameters: {
            "required": [
                  {
