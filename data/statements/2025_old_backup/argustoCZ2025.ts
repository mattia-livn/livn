...
export const imuRatesArgustoCZ2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: Zone A e C lottizzate",
    details: "A e Fabbricabili - Situate in determinate zone: A e fabbricabili: Zone “A” e “C lottizzate”",
    ratePercent: 0.86,
    categoryTypes: [],
    zone: "Zone A e C lottizzate"
  ,
    requiredParameters: {
            "required": [
                  {
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: Altre Zone",
    details: "A e Fabbricabili - Situate in determinate zone: A e fabbricabili: Alt Zone",
    ratePercent: 1.06,
    categoryTypes: [],
    zone: "Altre Zone"
  ,
