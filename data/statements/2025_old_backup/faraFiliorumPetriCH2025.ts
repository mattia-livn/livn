...
export const imuRatesFaraFiliorumPetriCH2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Reddito ISEE del comodatario non superio a € 5000",
    ratePercent: 0.27,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6"],
    context: "Con contratto registrato, Reddito ISEE del comodatario non superiore a € 5000"
  ,
    requiredParameters: {
      required: [
      {
