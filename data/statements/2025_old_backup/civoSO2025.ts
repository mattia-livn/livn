...
export const imuRatesCivoSO2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria - Categoria catastale: - /2 Case di cura ed ospedali senza fine di lucro",
