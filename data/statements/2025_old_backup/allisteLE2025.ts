...
export const imuRatesAllisteLE2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli coltivati e destinati ad alcuni tipi di coltura: ULIVO",
    details: "- Utilizzo: Coltivati e destinati ad alcuni tipi di coltura: ULIV O",
    ratePercent: 0.48,
    categoryTypes: [],
    context: "Coltivati e destinati ad alcuni tipi di coltura: ULIVO"
  ,
    requiredParameters: {
      required: [
      {
