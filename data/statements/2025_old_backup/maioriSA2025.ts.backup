...
export const imuRatesMaioriSA2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Locazione a canone libero, durata non inferiore a 48 mesi"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato nonche' abitazioni locate o concesse in comodato per periodi inferiori all'anno e comunque per un numero complessivo di mesi inferio a: mesi: 8 Categoria catastale: - A/1 Abitazioni di tipo signorile - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti p gi artistici o storici",
    ratePercent: 1.06
    categoryTypes: ["A/1","A/8","A/9"]
    context: "Non locate o concesse in comodato per meno di 8 mesi"
  ,
    requiredParameters: {
      required: [
      {
