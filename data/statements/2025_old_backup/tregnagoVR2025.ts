...
export const imuRatesTregnagoVR2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /2 Case di cura ed ospedali senza fine di lucro",
