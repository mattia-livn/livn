...
export const imuRatesAreseMI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - Collocazione immobile: Dentro il centro storico",
    ratePercent: 0.97,
    categoryTypes: ["D/3"],
