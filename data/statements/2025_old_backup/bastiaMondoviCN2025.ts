...
export const imuRatesBastiaMondoviCN2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati a disposizione o utilizzati direttamente dal soggetto passivo",
    details: "Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile nel caso di piccole e medie imp se",
    ratePercent: 0.87,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione utilizzata di ttamente dal soggetto passivo Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - A/11 Abitazioni ed alloggi tipici dei luoghi - Requisiti del soggetto passivo: Di proprieta' di ONLUS o enti del terzo setto",
    ratePercent: 0.87,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7","A/11"],
