...
export const imuRatesRoasioVC2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli ricadenti in specifiche zone",
    details: "- Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: Dal Fg. 1 al Fg. 11 della Sezione NCT \" \": Roasio/Castelletto Villa a a montana-zona di collina dep ssa e svantaggiataDal Fg. 1 al Fg. 35 comp so, della Sezione NCT \"A\": Roasio/Roasio zona di collina dep ssa e svantaggiata",
    ratePercent: 0
    categoryTypes: []
    zone: "Roasio/Castelletto Villa, Roasio/Roasio"
  ,
    requiredParameters: {
      required: [],
      conditional: [
