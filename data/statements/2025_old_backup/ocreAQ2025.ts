...
export const imuRatesOcreAQ2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "A e Fabbricabili - Situate in determinate zone: a e fabbricabili Zona Speciale C e/o che hanno ceduto l'intera cubaturaesprimibile in base alla destinazione d'uso p vista dal vigente PRG",
    ratePercent: 0.1,
    categoryTypes: [],
    zone: "Zona Speciale C"
  ,
    requiredParameters: {
            "required": [
                  {
