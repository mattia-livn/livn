...
export const imuRatesManerbaDelGardaBS2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C/2 Magazzini e locali di deposito, C/3 Laboratori per arti e mestieri, C/7 Tettoie chiuse od aperte",
    details: "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - C/7 Tettoie chiuse od aperte",
    ratePercent: 0.96,
    categoryTypes: ["C/2","C/3","C/7"]
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Limitatamente ad un solo immobile.",
    ratePercent: 0.86,
    categoryTypes: []
  ,
    requiredParameters: {
