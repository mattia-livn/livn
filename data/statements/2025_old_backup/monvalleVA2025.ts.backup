...
export const imuRatesMonvalleVA2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C, categorie catastali C/3, C/4, C/5",
    details: "- C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - C/5 Stabilimenti balneari e di acque curative senza fine di lucro",
    ratePercent: 0.94
