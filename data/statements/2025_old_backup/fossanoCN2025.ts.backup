...
export const imuRatesFossanoCN2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Tipologia di attivit�: Imp se che hanno ampliato la propria attivita' economica/aumentato l'occupazione come definite nel golamento",
    ratePercent: 0.86
    categoryTypes: []
  ,
    requiredParameters: {
