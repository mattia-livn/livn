...
export const imuRatesBergamoBG2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe con superficie non superiore a 250 MQ",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 250 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni - Codice ATECO: 47 - COMMERCIO AL D TAGLIO ESCLUSO QUELLO DI AUTOVEICOLI E DI MOTOCICLI",
    ratePercent: 0.76,
    categoryTypes: ["C/1"],
      ...
      },
  {
    ...
    details: "Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 100 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Codice ATECO: 56 - ATTIVITA' DEI SERVIZI DI RISTORAZIONE",
    ratePercent: 0.76,
    categoryTypes: ["C/1"],
    context: "Attività dei servizi di ristorazione"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe con superficie non superiore a 100 MQ",
    details: "Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 100 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.76,
    categoryTypes: ["C/1"],
      ...
      },
  {
    ...
    ratePercent: 0.96,
    categoryTypes: [],
    context: "Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019"
  ,
    requiredParameters: {
      required: [
      {
