...
export const imuRatesVicoDelGarganoFG2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria C, categoria C/1 e C/3 in area di valorizzazione commerciale centro storico",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: In una zona specificamente indicata dal comune: AREA DI VALORIZZAZIONE COMMERCIALE CENTRO STORICO APPROVATA CON DELIBERAZIONE DI CONSIGLIO COMUNALE IN DATA 26/07/2022 E SUCCESSIVE INTEGRAZIONI",
    ratePercent: 0.24,
    categoryTypes: ["C/1","C/3"],
    context: "In area di valorizzazione commerciale centro storico",
    zone: "AREA DI VALORIZZAZIONE COMMERCIALE CENTRO STORICO"
  ,
    requiredParameters: {
      required: [
      {
