...
export const imuRatesMozzoBG2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- immobili conferiti in trust istituito a favo di persone con handicap grave di cui all'art. 6 della legge n. 112 del 2016 con aliquota agevolata applicata: 0,4%;",
    ratePercent: 0.4,
    categoryTypes: [],
      ...
      },
  {
    ...
    ratePercent: 0,
    categoryTypes: [],
    context: "ONLUS o enti del terzo settore"
  ,
    requiredParameters: {
      required: [],
      conditional: [
