...
export const imuRatesCarosinoTA2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili dati in comodato gratuito al comune o ad altro ente territoriale",
    details: "- immobili dati in comodato gratuito art. 1, comma 777, lett. e, della legge n. 160 del 2019: al comune o ad altro ente territoriale esclusivamente per l'esercizio dei rispettivi scopi istituzionali;",
    ratePercent: 0,
    categoryTypes: [],
    context: "art. 1, comma 777, lett. e, della legge n. 160 del 2019"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Esercizi commerciali e artigianali situati in zone chiuse al traffico per lavori pubblici",
    details: "- esercizi commerciali e artigianali situati in zone p cluse al traffico a causa dello svolgimento di lavori per la alizzazione di ope pubbliche che si protraggono per olt sei mesi art. 1, comma 86, della legge n. 549 del 1995 con aliquota agevolata applicata: 0,43%.",
    ratePercent: 0.43,
    categoryTypes: [],
    context: "art. 1, comma 86, della legge n. 549 del 1995",
    zone: "zone chiuse al traffico"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
