...
export const imuRatesNoventaPadovanaPD2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Accordi/Patti territoriali per soddisfare particolari esigenze abitative come definiti nel regolamento",
