...
export const imuRatesGressoneySaintJeanAO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    context: "Esclusa categoria D/10"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.6
    categoryTypes: []
    context: "Locazione per uso abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale",
    ...
    ratePercent: 0.6
    categoryTypes: []
    context: "Comodato d'uso gratuito per uso abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro",
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferiore a 5 mesi",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferio a mesi, specifica : 5",
    ratePercent: 0.76
    categoryTypes: []
    context: "Locazione con contratto di almeno 5 mesi"
  ,
    requiredParameters: {
      required: [
      {
