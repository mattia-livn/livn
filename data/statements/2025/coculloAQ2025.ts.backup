...
export const imuRatesCoculloAQ2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Accordi/Patti territoriali per soddisfa particolari esigenze abitative come definiti nel golamento Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico",
    ratePercent: 0.76
