...
export const imuRatesSuranoLE2025: ImuRateEntry[] = [
  ...
  {
    condition: "Aree fabbricabili diverse da residenziali situate in determinate zone: zona p.i.p.",
    details: "A e Fabbricabili - Tipologia: Diverse da sidenziali - Situate in determinate zone: zona p.i.p.",
    ratePercent: 0.76,
    categoryTypes: [],
    zone: "zona p.i.p."
  ,
