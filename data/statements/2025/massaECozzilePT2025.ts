...
export const imuRatesMassaECozzilePT2025: ImuRateEntry[] = [
  ...
  {
    condition: "Terreni agricoli in area montana",
    details: "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: AREA MONTANA VEDI CIRCOLARE DEL MEF N° 9 DEL 14/06/1993",
    ratePercent: 0
    categoryTypes: []
    zone: "AREA MONTANA"
  ,
