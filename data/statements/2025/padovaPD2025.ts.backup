...
export const imuRatesPadovaPD2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato a studenti",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 5, comma 3, della Legge n. 431/1998 e s.m.i. - Condizioni locatario/comodatario: Studenti",
    ratePercent: 1.02
    categoryTypes: []
  ...
  {
    condition: "Abitazione locata o in comodato con destinazione d'uso abitazione principale",
      ...
      },
  {
    ...
    ratePercent: 0
    categoryTypes: []
    context: "Assegnati dagli IACP o enti simili"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
