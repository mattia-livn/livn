...
export const imuRatesCesenaFC2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    ratePercent: 1
    categoryTypes: ["D/1","D/2","D/3","D/6","D/7","D/9"]
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata o in comodato a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998",
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di comodato d'uso gratuito a parenti sino al primo grado",
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di comodato d'uso gratuito a parenti sino al primo grado in ipotesi diverse",
