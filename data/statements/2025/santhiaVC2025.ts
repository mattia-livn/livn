...
export const imuRatesSanthiaVC2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Soggetto gestore di struttura destinata all'accoglienza e protezione di persone vittime di violenza o che vivono in condizioni di disagio e vulnerabilità sociale",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Soggetto gesto di struttura destinata all'accoglienza e protezione di persone vittime di violenza o che vivono in condizioni di disagio e vulnerabilita' sociale",
    ratePercent: 0.46,
    categoryTypes: []
  ,
    requiredParameters: {
