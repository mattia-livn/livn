...
export const imuRatesVallefioritaCZ2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Limitatamente ad un solo immobile.",
    ratePercent: 0.38
    categoryTypes: []
