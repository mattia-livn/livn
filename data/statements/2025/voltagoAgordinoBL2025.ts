...
export const imuRatesVoltagoAgordinoBL2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito Categoria catastale: - A/11 Abitazioni ed alloggi tipici dei luoghi",
    ratePercent: 0.9
    categoryTypes: ["A/11"]
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    ratePercent: 0.9
    categoryTypes: ["/1","/4","C/1","C/3","C/4","C/7"]
  ,
    requiredParameters: {
      required: [],
      conditional: [],
