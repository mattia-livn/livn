...
export const imuRatesBattifolloCN2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "A e Fabbricabili - Tipologia: Diverse da sidenziali - Situate in determinate zone: a e coltivate da imp nditori agricoli e coltivatori di tti",
    ratePercent: 0,
    categoryTypes: [],
    context: "Coltivate da imprenditori agricoli e coltivatori diretti",
    zone: "Situate in determinate zone"
  ,
    requiredParameters: {
            "required": [
                  {
