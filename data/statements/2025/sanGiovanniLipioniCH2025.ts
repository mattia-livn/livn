...
export const imuRatesSanGiovanniLipioniCH2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    context: "Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
