...
export const imuRatesSanPancrazioSalentinoBR2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/1",
    details: "Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Impianti eolici e fotovoltaici - Codice ATECO: 35.11.00 - Produzione di energia elettrica",
    ratePercent: 1.06,
    categoryTypes: ["D/1"],
    context: "Impianti eolici e fotovoltaici"
  ,
    requiredParameters: {
      required: [
      {
