...
export const imuRatesCaraffaDelBiancoRC2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Esercizi commerciali e artigianali situati in zone chiuse al traffico a causa di lavori pubblici",
    ...
    ratePercent: 0.5
    categoryTypes: []
    context: "agevolazione per lavori pubblici"
