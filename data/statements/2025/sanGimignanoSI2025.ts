...
export const imuRatesSanGimignanoSI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Categoria catastale: D/1 Opifici, D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attività industriale",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 0.96,
  ...
  {
    condition: "Immobili di categoria C - Categoria catastale: C/3 Laboratori per arti e mestieri",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri",
    ratePercent: 0.96,
    categoryTypes: ["C/3"]
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Altri fabbricati fabbricati diversi Abitazione locata o in comodato",
    ratePercent: 0.89,
    categoryTypes: []
  ,
    requiredParameters: {
