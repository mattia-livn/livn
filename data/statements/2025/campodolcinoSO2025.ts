...
export const imuRatesCampodolcinoSO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro",
    ratePercent: 0.98,
    categoryTypes: ["D/6"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attività industriale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 0.98,
    categoryTypes: ["D/7"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attività commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni",
  ...
  {
    condition: "Immobili di categoria A10 - Uffici e studi privati",
