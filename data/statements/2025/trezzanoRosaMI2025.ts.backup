...
export const imuRatesTrezzanoRosaMI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico",
    ratePercent: 1.06
