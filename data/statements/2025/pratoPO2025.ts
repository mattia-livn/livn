...
export const imuRatesPratoPO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile tutti - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 1.02,
    categoryTypes: ["D/7"]
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.76,
    categoryTypes: ["D/3"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili conferiti in trust istituito a favore di persone con handicap grave",
    details: "- immobili conferiti in trust istituito a favo di persone con handicap grave di cui all'art. 6 della legge n. 112 del 2016 con aliquota agevolata applicata: 0,76%.",
    ratePercent: 0.76,
    categoryTypes: []
  ,
    requiredParameters: {
