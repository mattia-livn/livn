...
export const imuRatesValledolmoPA2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 3-4-6-7-10",
    ratePercent: 0,
    categoryTypes: [],
    zone: "fogli catastali: 3-4-6-7-10"
  ,
    requiredParameters: {
      required: [],
      conditional: [
