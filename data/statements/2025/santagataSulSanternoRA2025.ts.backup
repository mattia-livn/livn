...
export const imuRatesSantagataSulSanternoRA2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Comodato d'uso gratuito, categorie catastali A/2, A/3, A/4, A/5, A/6, A/7",
  ...
  {
    condition: "Abitazione locata o in comodato - Comodato d'uso gratuito, categorie catastali A/2, A/3, A/4, A/5, A/6, A/7, con contratto registrato",
    ...
    ratePercent: 0.96
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"]
    context: "Comodato d'uso gratuito, utilizzata come abitazione principale, con contratto registrato"
  ,
    requiredParameters: {
      required: [
      {
