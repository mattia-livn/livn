...
export const imuRatesPaloDelColleBA2025: ImuRateEntry[] = [
  ...
  {
    condition: "Terreni agricoli coltivati e destinati ad alcuni tipi di coltura",
    details: "- Utilizzo: Coltivati e destinati ad alcuni tipi di coltura: ter ni a immutabile destinazione agro-silvo-pastorale a propriet� collettiva indivisibile e inusucapibile",
    ratePercent: 0
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata con contratto ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i.",
