...
export const imuRatesMontefelcinoPU2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D con potenza impianti produzione energia superiore a 15 kW",
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Potenza impianti produzione energia, superiore a kW: 15",
    ratePercent: 1.06,
    categoryTypes: ["D"]
  ,
    requiredParameters: {
