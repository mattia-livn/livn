...
export const imuRatesBadiaPolesineRO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "- Utilizzo: Coltivati da pa nti e affini di coltivatori entro il terzo grado - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: In tutto il territorio comunale",
    ratePercent: 0.9
    categoryTypes: []
    context: "Coltivati da parenti e affini di coltivatori entro il terzo grado"
