...
export const imuRatesMassignanoAP2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato e utilizzata come abitazione principale, ipotesi diverse",
    ...
    ratePercent: 0.46,
    categoryTypes: [],
    context: "Con contratto registrato e utilizzata come abitazione principale, ipotesi diverse"
  ,
    requiredParameters: {
      required: [
      {
