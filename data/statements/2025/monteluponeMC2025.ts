...
export const imuRatesMonteluponeMC2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D destinati a nuovo insediamento produttivo",
    details: "Categoria catastale: - D/1 Opifici - Collocazione immobile: In una zona specificamente indicata dal comune: OPIFICI CAT. D DESTINATI A NUOVO INSEDIAMENTO PRODUTTIVO PER MASSIMO 3 ANNI PRESSO PIP AN O E ZONA INDUSTRIALE AN O.",
    ratePercent: 0.86,
    categoryTypes: ["D/1"],
    context: "Destinati a nuovo insediamento produttivo per massimo 3 anni",
    zone: "PIP AN O e zona industriale AN O"
  ,
    requiredParameters: {
      required: [
      {
