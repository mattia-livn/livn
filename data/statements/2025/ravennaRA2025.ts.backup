...
export const imuRatesRavennaRA2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 1.02
    categoryTypes: []
    context: "Ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
