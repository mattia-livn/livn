...
export const imuRatesSchioVI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "A e Fabbricabili - Situate in determinate zone: A e fabbricabili ricadenti nelle zone di Pe quazione Urbanistica individuate dagli strumenti golatori",
    ratePercent: 0.88,
    categoryTypes: [],
    zone: "Pequazione Urbanistica"
  ,
    requiredParameters: {
            "required": [
                  {
