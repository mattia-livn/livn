...
export const imuRatesLuvinateVA2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali n.: 901, 902 e 903",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 901, 902 e 903 circola del Ministero delle finanze n. 9 del 14 giugno 1993 Comune “PD”",
    ratePercent: 0
    categoryTypes: []
    context: "Ricadenti nei fogli catastali n.: 901, 902 e 903"
    zone: "Comune “PD”"
  ,
    requiredParameters: {
      required: [],
