...
export const imuRatesCastelleoneDiSuasaAN2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Potenza impianti produzione energia, superio a kW: 200",
    ratePercent: 1.06,
    categoryTypes: ["D"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Altri fabbricati, abitazione locata o in comodato",
