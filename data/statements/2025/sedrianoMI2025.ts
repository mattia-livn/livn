...
export const imuRatesSedrianoMI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato e condizioni locatario/comodatario parenti sino al primo grado",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019",
    ratePercent: 0.93,
    categoryTypes: []
  ,
    requiredParameters: {
