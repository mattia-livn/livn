...
export const imuRatesCastrignanoDelCapoLE2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili utilizzati direttamente dal soggetto passivo - Codice ATECO: 10.4 - PRODUZIONE DI OLI E GRASSI VEGETALI E ANIMALI",
    ratePercent: 0.76,
    categoryTypes: ["D/1"],
