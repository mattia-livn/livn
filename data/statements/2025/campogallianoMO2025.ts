...
export const imuRatesCampogallianoMO2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli in zone esondabili dal fiume Secchia 2018",
    details: "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: Zone esondabili dal fiume Secchia 2018 come individuate da golamento IMU",
    ratePercent: 0.76,
    categoryTypes: [],
    zone: "Zone esondabili dal fiume Secchia 2018"
  ,
    requiredParameters: {
            "required": [
                  {
  ...
  {
    condition: "Terreni agricoli in zone esondabili dal fiume Secchia 2014",
    details: "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: Zone esondabili dal fiume Secchia 2014 come individuate da golamento IMU",
    ratePercent: 0.52,
    categoryTypes: [],
    zone: "Zone esondabili dal fiume Secchia 2014"
  ,
    requiredParameters: {
            "required": [
                  {
  ...
  {
    condition: "Abitazione locata o in comodato in zone esondabili dal fiume Secchia 2014",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Collocazione immobile: In una zona specificamente indicata dal comune: Zone esondabili dal fiume Secchia 2014 come individuate da golamento IMU",
    ratePercent: 0.83,
    categoryTypes: [],
    zone: "Zone esondabili dal fiume Secchia 2014"
  ,
