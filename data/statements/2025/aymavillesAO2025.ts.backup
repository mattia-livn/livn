...
export const imuRatesAymavillesAO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Fabbricati divenuti inagibili a seguito di calamità naturali"
    zone: "località La Camagne"
  ,
    requiredParameters: {
      required: [
      {
