...
export const imuRatesVerbaniaVB2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    ratePercent: 0.76,
    categoryTypes: [],
    context: "Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale."
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998 e s.m.i. - Condizioni locatario/comodatario: Studenti - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.76,
    categoryTypes: [],
