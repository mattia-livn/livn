...
export const imuRatesZoppeDiCadoreBL2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferiore a mesi, specifica: 1",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferio a mesi, specifica : 1",
    ratePercent: 0.3
    categoryTypes: []
  ,
    requiredParameters: {
