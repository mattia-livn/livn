...
export const imuRatesPontederaPI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Immobili non produttivi di ddito fondiario art. 43 T.U.I.R. - Numero di dipendenti non superio a, specifica indica il numero dei dipendenti: 15",
    ratePercent: 0.86
    categoryTypes: ["D"]
    context: "Numero di dipendenti: 15"
  ,
    requiredParameters: {
      required: [
      {
