...
export const imuRatesCastelgombertoVI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Aree Fabbricabili - Tipologia: Diverse da residenziali - Situate in determinate zone: Zona Territoriale Omogenea F impianti di interesse generale",
    ratePercent: 0,
    categoryTypes: [],
    context: "Diverse da residenziali",
    zone: "Zona Territoriale Omogenea F impianti di interesse generale"
  ,
    requiredParameters: {
            "required": [
                  {
