...
export const imuRatesCassagoBrianzaLC2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria A/10, C/3, C/4, C/5",
    details: "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/3 Laboratori per arti e mestieri - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - C/5 Stabilimenti balneari e di acque curative senza fine di lucro",
    ratePercent: 0.96,
    categoryTypes: ["A/10","C/3","C/4","C/5"]
  ,
    requiredParameters: {
      required: [
      {
