...
export const imuRatesCasaleSulSileTV2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Codice ATECO: 52",
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 52 - MAGAZZINAGGIO E ATTIVITA' DI SUPPORTO AI TRASPORTI",
    ratePercent: 1,
    categoryTypes: ["D"],
    context: "Codice ATECO: 52"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Codice ATECO: 49.4",
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 49.4 - TRASPORTO DI MERCI SU STRADA E SERVIZI DI TRASLOCO",
    ratePercent: 1,
    categoryTypes: ["D"],
    context: "Codice ATECO: 49.4"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D - Abitazione locata o in comodato - Comodato d'uso gratuito - Condizioni locatario/comodatario: Parenti sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019",
  ...
  {
    condition: "Altri fabbricati diversi - Immobili di categoria A10, C",
    details: "Altri fabbricati fabbricati diversi - Immobili di categoria A10, C",
    ratePercent: 0.9,
