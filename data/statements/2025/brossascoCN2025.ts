...
export const imuRatesBrossascoCN2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - C/7 Tettoie chiuse od aperte - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.86,
    categoryTypes: ["C/2","C/7"]
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C utilizzati per negozi e botteghe o laboratori per arti e mestieri",
