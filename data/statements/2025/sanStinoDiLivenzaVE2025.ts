...
export const imuRatesSanStinoDiLivenzaVE2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    ratePercent: 0.7,
    categoryTypes: [],
    context: "Condizioni locatario/comodatario: Parenti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019"
  ,
    requiredParameters: {
      required: [
      {
