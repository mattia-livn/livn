...
export const imuRatesRomanoCanaveseTO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali dal 24 al 31",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: dal 24 al 31",
    ratePercent: 0
    categoryTypes: []
    context: "Ricadenti nei fogli catastali dal 24 al 31"
    zone: "fogli catastali: dal 24 al 31"
  ,
    requiredParameters: {
      required: [],
      conditional: [
