...
export const imuRatesPerosaArgentinaTO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria - Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme",
    details: "Immobili di categoria Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - Superficie: Non superio a Mq 4500 MQ",
    ratePercent: 0.43,
    categoryTypes: [],
    context: "Superficie non superiore a 4500 MQ"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
