...
export const imuRatesVillarFocchiardoTO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 0.8
    categoryTypes: ["A/4"]
    context: "Abitazioni di tipo popolare"
    zone: "Fabbricati situati nelle borgate montane"
  ,
    requiredParameters: {
      required: [
      {
