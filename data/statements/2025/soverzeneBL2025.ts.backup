...
export const imuRatesSoverzeneBL2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Codice ATECO: 35.11.00 - Produzione di energia elettrica",
    ratePercent: 1.06
    categoryTypes: ["D/1"]
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Codice ATECO: 35.12.00 - Trasmissione di energia elettrica",
    ratePercent: 1.06
    categoryTypes: ["D/1"]
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Codice ATECO: 35.13.00 - Distribuzione di energia elettrica",
    ratePercent: 1.06
    categoryTypes: ["D/1"]
