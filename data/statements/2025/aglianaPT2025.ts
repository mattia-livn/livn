...
export const imuRatesAglianaPT2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Requisiti soggettivi del locatario o comodatario: ONLUS o altri enti del terzo setto",
    ratePercent: 0.96,
    categoryTypes: ["D/3"],
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/6",
    details: "Categoria catastale: - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Requisiti soggettivi del locatario o comodatario: ONLUS o altri enti del terzo setto",
    ratePercent: 0.96,
    categoryTypes: ["D/6"],
    context: "Immobili locati o concessi in comodato"
  ,
      ...
      },
  {
    ...
    details: "Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non inferio a: 12",
    ratePercent: 0.96,
    categoryTypes: ["C/1"],
  ...
  {
    condition: "Immobili di categoria C, categoria C/1 locati o concessi in comodato",
  ...
  {
    condition: "Immobili di categoria C, categoria C/2",
    details: "Categoria catastale: - C/2 Magazzini e locali di deposito - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Requisiti soggettivi del locatario o comodatario: ONLUS o altri enti del terzo setto",
    ratePercent: 0.96,
    categoryTypes: ["C/2"],
    context: "Immobili locati o concessi in comodato"
  ,
  ...
  {
    condition: "Immobili di categoria C, categoria C/4",
    details: "Categoria catastale: - C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Requisiti soggettivi del locatario o comodatario: ONLUS o altri enti del terzo setto",
    ratePercent: 0.96,
    categoryTypes: ["C/4"],
    context: "Immobili locati o concessi in comodato"
  ,
      ...
      },
  {
    ...
    details: "Categoria catastale: - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Requisiti soggettivi del locatario o comodatario: ONLUS o altri enti del terzo setto",
    ratePercent: 0.96,
    categoryTypes: ["C/3"],
    context: "Immobili locati o concessi in comodato"
  ,
