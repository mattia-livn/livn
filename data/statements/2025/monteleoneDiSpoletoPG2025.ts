...
export const imuRatesMonteleoneDiSpoletoPG2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria A/10, C/3",
    details: "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/3 Laboratori per arti e mestieri",
    ratePercent: 0.76
    categoryTypes: ["A/10","C/3"]
  ,
    requiredParameters: {
      required: [
      {
