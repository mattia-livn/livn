...
export const imuRatesSaintRhemyEnBossesAO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/2 Magazzini e locali di deposito",
    ratePercent: 0.56,
    categoryTypes: ["C/6","C/2"]
  ,
    requiredParameters: {
      required: [],
      conditional: [],
