...
export const imuRatesSanSeverinoMarcheMC2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D - Oggetto di attivit� di cupero per miglioramento del decoro urbano o della classe energetica.",
    ratePercent: 0.91,
    categoryTypes: ["D"],
    context: "Oggetto di attività di recupero"
  ,
    requiredParameters: {
      required: [],
      conditional: [
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D, immobili di categoria A10, C oggetto di attività di recupero per miglioramento del decoro urbano o della classe energetica",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D Immobili di categoria A10, , C - Oggetto di attivit� di cupero per miglioramento del decoro urbano o della classe energetica.",
    ratePercent: 1.01,
    categoryTypes: ["A10","C"],
    context: "Oggetto di attività di recupero"
  ,
