...
export const imuRatesPonteDiPiaveTV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 0.86
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"]
    context: "Con contratto registrato, condizioni locatario/comodatario: parenti sino al primo grado, limitatamente ad un solo immobile"
  ,
    requiredParameters: {
      required: [
      {
