...
export const imuRatesLoretoAN2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Superficie: Non superio a Mq 500 MQ",
    ratePercent: 0.86
    categoryTypes: ["C/1","C/3"]
    context: "Superficie non superiore a 500 MQ"
  ,
    requiredParameters: {
      required: [
      {
