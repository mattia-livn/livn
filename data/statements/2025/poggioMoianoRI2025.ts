...
export const imuRatesPoggioMoianoRI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attività commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 1.06,
    categoryTypes: ["D/8"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Fabbricati situati in determinate zone: Categoria C/2, C/3, D/2",
    details: "- Situate in determinate zone: Categoria C/2 Categoria C/3Categoria D/2",
    ratePercent: 0.65,
    categoryTypes: ["C/2","C/3","D/2"]
  ,
    requiredParameters: {
      required: [
      {
