...
export const imuRatesNulviSS2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D per unità immobiliari ad uso produttivo soggetti NON residenti o NON aventi sede legale nel Comune di Nulvi",
    details: "Aliquota per unità immobiliari ad uso produttivo del gruppo catastale D soggetti NON residenti o NON aventi sede legale nel Comune di Nulvi",
    ratePercent: 1.14,
    categoryTypes: ["D"],
