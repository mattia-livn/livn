...
export const imuRatesCasalmaggioreCR2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "- Tipologia: Residenziali - Situate in determinate zone: Ambito della rigenerazione urbana \"RIG. 03\" a a ex-ospedale individuata dal Documento di Piano della variante generale al Piano di Governo del Territorio PGT approvata con delibera di Consiglio Comunale n. 30 del 18/05/2023",
    ratePercent: 0.764,
    categoryTypes: [],
    context: "Ambito della rigenerazione urbana \"RIG. 03\" a a ex-ospedale",
    zone: "Documento di Piano della variante generale al Piano di Governo del Territorio PGT"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
      ...
      },
  {
    ...
    details: "- Tipologia: Diverse da sidenziali - Situate in determinate zone: Ambito della rigenerazione urbana \"RIG. 03\" a a ex-ospedale individuata dal Documento di Piano della variante generale al Piano di Governo del Territorio PGT approvata con delibera di Consiglio Comunale n. 30 del 18/05/2023",
    ratePercent: 0.764,
    categoryTypes: [],
    context: "Ambito della rigenerazione urbana \"RIG. 03\" a a ex-ospedale",
    zone: "Documento di Piano della variante generale al Piano di Governo del Territorio PGT"
