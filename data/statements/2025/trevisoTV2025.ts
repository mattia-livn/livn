...
export const imuRatesTrevisoTV2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/3, immobili locati",
    details: "Categoria catastale: - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili locati - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 1.02,
    categoryTypes: ["D/3"],
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/3, immobili utilizzati direttamente",
    ...
    ratePercent: 1.02,
    categoryTypes: ["D/3"],
    context: "Immobili utilizzati direttamente"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C, categoria C/1, negozi e botteghe, immobili locati",
  ...
  {
    condition: "Immobili di categoria C, categoria C/1, negozi e botteghe, immobili utilizzati direttamente",
