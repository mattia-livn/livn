...
export const imuRatesPomarancePI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/9",
    details: "Categoria catastale: - D/9 Edifici galleggianti o sospesi assicurati a punti fissi del suolo, ponti privati soggetti a pedaggio",
    ratePercent: 0.76
    categoryTypes: ["D/9"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie D/1 e D/5",
  ...
  {
    condition: "Immobili di categoria /6",
    details: "Immobili di categoria Categoria catastale: - /6 iblioteche, pinacoteche, musei, gallerie, accademie che non hanno sede in edifici della categoria A/9",
    ratePercent: 0
    categoryTypes: ["/6"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria /7",
    details: "- /7 Cappelle ed oratori non destinati all'esercizio pubblico del culto",
    ratePercent: 0
    categoryTypes: ["/7"]
  ,
    requiredParameters: {
