...
export const imuRatesSeravezzaLU2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/4 Case di cura ed ospedali con fine di lucro - D/5 Istituto di credito, cambio e assicurazione con fine di lucro - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro",
    ratePercent: 1.14,
    categoryTypes: ["D/4","D/5","D/6"]
  ,
    requiredParameters: {
      required: [],
      conditional: [],
