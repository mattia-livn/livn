...
export const imuRatesSoglianoAlRubiconeFC2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato con specifiche categorie catastali",
  ...
  {
    condition: "Immobili di categoria C con specifiche condizioni",
    details: "Immobili di categoria , C Categoria catastale: - /8 Magazzini sotterranei per depositi di derrate - C/1 Negozi e botteghe - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non superio a: 60",
    ratePercent: 0.4
