...
export const imuRatesNuraminisSU2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    ratePercent: 0,
    categoryTypes: [],
    context: "Utilizzo: Ter ni agricoli condotti da CD e IAP e Societa' agricole non posseduti"
  ,
    requiredParameters: {
      required: [],
      conditional: [
      ...
      },
  {
    ...
    ratePercent: 0.76,
    categoryTypes: [],
    context: "Utilizzo: Coltivati da pa nti e affini di coltivatori entro il terzo grado"
  ,
    requiredParameters: {
      required: [],
      conditional: [
