...
export const imuRatesCamerinoMC2025: ImuRateEntry[] = [
  {
    ...
    },
  {
    ...
    context: "Con contratto registrato, condizioni locatario/comodatario: parenti sino al primo grado"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - Durata del contratto di durata non inferio a mesi, specifica : 12 - Collocazione immobile: In una zona specificamente indicata dal comune: fg 125 e fg 61",
    ratePercent: 0.53,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"],
    context: "Durata del contratto non inferiore a 12 mesi",
    zone: "fg 125 e fg 61"
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale - Collocazione immobile: In una zona specificamente indicata dal comune: fg 125 e fg 61",
    ratePercent: 0.53,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"],
    context: "Con contratto registrato, condizioni locatario/comodatario: parenti sino al secondo grado",
    zone: "fg 125 e fg 61"
  ,
    requiredParameters: {
      required: [
