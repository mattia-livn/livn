...
export const imuRatesCeresoleAlbaCN2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe utilizzati per attività produttiva e/o commerciale o per l'esercizio di arti e professioni",
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe utilizzati come bottega storica o artigiana",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.91,
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe a disposizione",
