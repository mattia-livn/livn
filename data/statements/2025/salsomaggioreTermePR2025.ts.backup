...
export const imuRatesSalsomaggioreTermePR2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Condizioni locatario/comodatario: Studenti",
    ratePercent: 1
    categoryTypes: []
  ...
  {
    condition: "Abitazione locata o in comodato a parenti sino al secondo grado",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale - Limitatamente ad un solo immobile.",
    ratePercent: 1
    categoryTypes: []
    context: "Comodato d'uso gratuito a parenti sino al secondo grado"
  ,
    requiredParameters: {
      required: [
      {
