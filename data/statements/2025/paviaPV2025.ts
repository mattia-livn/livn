...
export const imuRatesPaviaPV2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D a disposizione di ONLUS o enti del terzo settore",
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D/3 utilizzati per attività di proiezione cinematografica",
    details: "Categoria catastale: - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Codice ATECO: 59.14.0 - Attivita' di proiezione cinematografica",
    ratePercent: 0.76
    categoryTypes: ["D/3"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Altri fabbricati locati o in comodato con contratto ai sensi dell'art. 2, comma 3, della Legge n.431/1998",
  ...
  {
    condition: "Altri fabbricati locati o in comodato con contratto ai sensi dell'art. 5, comma 1, della Legge n. 431/1998",
  ...
  {
    condition: "Altri fabbricati locati o in comodato con contratto ai sensi dell'art. 5, comma 2, della Legge n. 431/1998",
  ...
  {
    condition: "Altri fabbricati locati o in comodato con contratto ai sensi dell'art. 5, comma 3, della Legge n. 431/1998",
  ...
  {
    condition: "Altri fabbricati in comodato d'uso gratuito di proprietà di ONLUS o enti del terzo settore",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Requisiti del soggetto passivo: Di proprieta' di ONLUS o enti del terzo setto",
    ratePercent: 0.46
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Altri fabbricati a disposizione di ONLUS o enti del terzo settore",
