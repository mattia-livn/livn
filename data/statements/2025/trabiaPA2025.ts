...
export const imuRatesTrabiaPA2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli coltivati in determinate aree",
    details: "- Utilizzo: Coltivati - Collocazione: Ter ni ricadenti in determinate a e: A a: Ter ni agricoli p senti in circola n. 9/93 Ministero FinanzePD parziale delimitazione e quelli posseduti da coltivatori di tti, imp nditori agricoli e a immutabile destinazione agro-silvo pastorale a propri�ta collettiva-",
    ratePercent: 0,
    categoryTypes: [],
    zone: "determinate aree"
  ,
    requiredParameters: {
            "required": [
                  {
