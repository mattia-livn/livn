...
export const imuRatesAglientuSS2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: Tutti i ter ni ricadenti nel territorio comunale",
    ratePercent: 0,
    categoryTypes: [],
    context: "Tutti i terreni ricadenti nel territorio comunale"
  ,
    requiredParameters: {
      required: [],
      conditional: [
