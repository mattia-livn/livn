...
export const imuRatesCerianoLaghettoMB2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione a disposizione, non locate e non concesse in comodato, fabbricati inagibili",
