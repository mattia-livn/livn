...
export const imuRatesRoccamontepianoCH2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "A e Fabbricabili - Tipologia: Diverse da sidenziali - Situate in determinate zone: a e edificabili ricadenti in zona “F1” “F2” “P” “V” “D2” “D3”",
    ratePercent: 0
    categoryTypes: []
    zone: "F1, F2, P, V, D2, D3"
  ,
    requiredParameters: {
            "required": [
                  {
