...
export const imuRatesAgnoneIS2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: AREE CLASSE C1-AREE NON ANCORA LOTTIZZATE",
    details: "Aree fabbricabili - Tipologia: Diverse da residenziali - Situate in determinate zone: AREE CLASSE C1-AREE NON ANCORA LOTTIZZATE",
    ratePercent: 0.76,
    categoryTypes: [],
    zone: "AREE CLASSE C1-AREE NON ANCORA LOTTIZZATE"
  ,
    requiredParameters: {
      required: [
      {
