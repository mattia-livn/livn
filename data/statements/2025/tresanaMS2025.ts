...
export const imuRatesTresanaMS2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Requisiti soggettivi del locatario o comodatario: ONLUS o altri enti del terzo setto - Codice ATECO: 94.99.90 - Attivita' di alt organizzazioni associative nca - Con contratto gistrato *Per contratti di locazione di immobili devono intendersi esclusivamente quelli gistrati ai sensi delle vigenti disposizioni di legge.",
    ratePercent: 0.46
    categoryTypes: ["C/1"]
    context: "Immobili locati o concessi in comodato a ONLUS o altri enti del terzo settore"
  ,
    requiredParameters: {
      required: [
      {
