...
export const imuRatesFiesoleFI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Requisiti del soggetto passivo: Portatore di handicap grave",
  ...
  {
    condition: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Requisiti del soggetto passivo: Soggetto con invalidità civile riconosciuta in percentuale non inferiore al 100%",
