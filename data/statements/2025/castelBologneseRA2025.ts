...
export const imuRatesCastelBologneseRA2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati",
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.9,
    categoryTypes: ["A10","C"],
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Accordi/Patti territoriali per soddisfa particolari esigenze abitative come definiti nel golamento - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.73,
    categoryTypes: [],
