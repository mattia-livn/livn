...
export const imuRatesLugoRA2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione a disposizione non locata e non concessa in comodato, fabbricati inagibili a seguito di calamità naturali",
    ...
    ratePercent: 0,
    categoryTypes: [],
    context: "Non locata, non concessa in comodato, inagibili a seguito di calamità naturali"
  ,
    requiredParameters: {
      required: [
      {
