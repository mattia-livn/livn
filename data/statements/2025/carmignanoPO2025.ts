...
export const imuRatesCarmignanoPO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati a disposizione o utilizzati: Immobili a disposizione - Purché la condizione di immobile a disposizione persista da almeno 12 mesi",
  ...
  {
    condition: "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati: Immobili a disposizione - Purché la condizione di immobile a disposizione persista da almeno 12 mesi",
  ...
  {
    condition: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Periodo non coperto da contratti purché la condizione di immobile a disposizione persista da almeno 12 mesi",
