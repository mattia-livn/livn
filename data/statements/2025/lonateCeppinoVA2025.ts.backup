...
export const imuRatesLonateCeppinoVA2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    context: "Purchè l'affittuario/comodatario la utilizzi come abitazione principale. Limitatamente ad un solo immobile."
  ,
    requiredParameters: {
      required: [
      {
