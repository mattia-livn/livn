...
export const imuRatesGrosioSO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Categoria catastale: - C/2 Magazzini e locali di deposito - Collocazione immobile: In una zona specificamente indicata dal comune: immobili ubicati all’esterno del Centro abitato, perimetrato con deliberazione di Giunta comunale n. 69 del 12 aprile 2000",
    ratePercent: 0.46
    categoryTypes: ["C/2"]
    context: "Immobili ubicati all’esterno del Centro abitato"
    zone: "Perimetrato con deliberazione di Giunta comunale n. 69 del 12 aprile 2000"
  ,
    requiredParameters: {
      required: [
      {
