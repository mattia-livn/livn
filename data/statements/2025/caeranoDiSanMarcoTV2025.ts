...
export const imuRatesCaeranoDiSanMarcoTV2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Periodo non coperto da contratti purché la condizione di immobile a disposizione persista da almeno: 6",
    ratePercent: 0.95,
    categoryTypes: [],
    context: "Periodo non coperto da contratti"
  ,
    requiredParameters: {
      required: [
      {
