...
export const imuRatesCasazzaBG2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria C/3, laboratori per arti e mestieri, fabbricati a disposizione o utilizzati",
    details: "Immobili di categoria C Categoria catastale: - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili a disposizione - Purché la condizione di immobile a disposizione persista da almeno: 12 mesi - Limitatamente ad un solo immobile.",
    ratePercent: 0.76,
    categoryTypes: ["C/3"],
    context: "Purché la condizione di immobile a disposizione persista da almeno 12 mesi"
  ,
    requiredParameters: {
      required: [
      {
