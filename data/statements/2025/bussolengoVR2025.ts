...
export const imuRatesBussolengoVR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato, tipo contratto: Comodato d'uso gratuito, categoria catastale A/2, A/3",
  ...
  {
    condition: "Abitazione utilizzata direttamente dal soggetto passivo, categoria catastale A/1, A/8, A/9, con requisiti specifici",
    ...
    ratePercent: 0.3,
    categoryTypes: ["A/1","A/8","A/9"],
    context: "Portato di handicap grave, Reddito ISEE non superiore a € 20000,00"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione utilizzata direttamente dal soggetto passivo, categoria catastale A/1, A/8, A/9, con invalidità civile",
    ...
    ratePercent: 0.3,
    categoryTypes: ["A/1","A/8","A/9"],
    context: "Invalidità civile riconosciuta al 100%, Reddito ISEE non superiore a € 20000,00"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C/1, C/3, utilizzati direttamente dal soggetto passivo come bottega storica o artigiana",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.7,
