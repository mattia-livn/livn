...
export const imuRatesCardanoAlCampoVA2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/1 e D/2",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/2 Alberghi e pensioni con fine di lucro",
    ratePercent: 1.03
