...
export const imuRatesMonterotondoRM2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D in una zona specificamente indicata dal comune",
    details: "Fabbricati appartenenti al gruppo catastale D - Collocazione immobile: In una zona specificamente indicata dal comune: Tutti gli immobili ricomp si nei fogli catastali: 06 - 09 - 16 - 17",
    ratePercent: 0.98,
    categoryTypes: ["D"],
    zone: "Fogli catastali: 06 - 09 - 16 - 17"
  ,
    requiredParameters: {
      required: [],
      conditional: [
