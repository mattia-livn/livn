...
export const imuRatesPortoCesareoLE2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Con contratto gistrato - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.682
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato, utilizzata come abitazione principale, categorie catastali A/1, A/2, A/3, A/4, A/5, A/6, A/7",
  ...
  {
    condition: "Immobili di categoria C, categorie catastali C/1, C/3",
      ...
      },
  {
    ...
    details: "- C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro",
    ratePercent: 0.81
    categoryTypes: ["C/4"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione a disposizione, categorie catastali A/1, A/2, A/3, A/4, A/5, A/6, A/7",
