...
export const imuRatesRezzatoBS2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.92,
  ...
  {
    condition: "Terreni agricoli",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: dal 17 in poi ubicati a sud del Naviglio",
    ratePercent: 0.94,
    categoryTypes: [],
    zone: "Ricadenti nei fogli catastali n.: dal 17 in poi ubicati a sud del Naviglio"
  ,
    requiredParameters: {
            "required": [
                  {
    ...
    },
  {
    ...
    ratePercent: 0.9,
    categoryTypes: ["A/10","C/1","C/2","C/3","C/4","C/6"]
  ,
    requiredParameters: {
      required: [
      {
