...
export const imuRatesArdoreRC2025: ImuRateEntry[] = [
  {
    condition: "Abitazione principale di categoria catastale A/1, A/8 e A/9 e relative pertinenze",
    details: "Abitazione principale di categoria catastale A/1, A/8 e A/9 e relative pertinenze",
    ratePercent: 0.6,
      ...
      },
  {
    ...
    details: "Assimilazione all’abitazione principale dell’unità immobiliare posseduta da anziani o disabili di cui all'art. 1, comma 741, lett. c, n. 6, della legge n. 160 del 2019",
    ratePercent: 0.6,
    categoryTypes: [],
    context: "SI"
  ,
      ...
      },
  {
    ...
    details: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D",
    ratePercent: 1,
    categoryTypes: []
  ,
    requiredParameters: {
