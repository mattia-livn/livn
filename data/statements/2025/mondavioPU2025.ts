...
export const imuRatesMondavioPU2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, per impianti fotovoltaici a terra",
    details: "- Collocazione immobile: In una zona specificamente indicata dal comune: Per impianti fotovoltaici a terra in qualsiasi categoria catastale.",
    ratePercent: 1.06
    categoryTypes: ["D"]
    context: "Per impianti fotovoltaici a terra"
