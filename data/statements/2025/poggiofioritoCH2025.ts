...
export const imuRatesPoggiofioritoCH2025: ImuRateEntry[] = [
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: ZONE DI TIPO A",
    details: "Aree fabbricabili - Situate in determinate zone: ZONE DI TIPO A – 30,00/MQ",
    ratePercent: 1.06
    categoryTypes: []
    zone: "ZONE DI TIPO A"
  ,
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: ZONE DI TIPO B",
    details: "Aree fabbricabili - Situate in determinate zone: ZONE DI TIPO B – 25,00/MQ",
    ratePercent: 1.06
    categoryTypes: []
    zone: "ZONE DI TIPO B"
  ,
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: ZONE DI TIPO C",
    details: "Aree fabbricabili - Situate in determinate zone: ZONE DI TIPO C – 18,00/MQ",
    ratePercent: 1.06
    categoryTypes: []
    zone: "ZONE DI TIPO C"
  ,
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: ZONE DI TIPO D",
    details: "Aree fabbricabili - Situate in determinate zone: ZONE DI TIPO D – 15,00/MQ",
    ratePercent: 1.06
    categoryTypes: []
    zone: "ZONE DI TIPO D"
  ,
