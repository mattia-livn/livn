...
export const imuRatesSirmioneBS2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione destinata a struttura turistico-ricettiva - In attività da almeno mesi: 1",
    details: "Abitazione destinata a struttura turistico-ricettiva - In attivit� da almeno mesi: 1",
    ratePercent: 1.06,
    categoryTypes: [],
    context: "In attività da almeno mesi: 1"
  ,
    requiredParameters: {
      required: [],
      conditional: [
