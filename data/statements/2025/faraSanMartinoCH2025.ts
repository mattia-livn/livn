...
export const imuRatesFaraSanMartinoCH2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/1 e D/2",
    details: "Categoria catastale: - D/1 Opifici - D/2 Alberghi e pensioni con fine di lucro",
    ratePercent: 0.88,
    categoryTypes: ["D/1","D/2"]
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria A10, categoria A/10",
