...
export const imuRatesCastiglioneDellaPescaiaGR2025: ImuRateEntry[] = [
  ...
  ,
    requiredParameters: {
            ...
            "commune": "castiglioneDellaPescaia"
      },
  {
      ...
      },
  {
    ...
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.86,
