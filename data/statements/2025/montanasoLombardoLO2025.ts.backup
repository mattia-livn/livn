...
export const imuRatesMontanasoLombardoLO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di locazione ai sensi dell'art. 5, comma 3, della Legge n. 431/1998",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 5, comma 3, della Legge n. 431/1998 e s.m.i. Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - Durata del contratto di durata non inferio a mesi, specifica : 48",
    ratePercent: 0.8
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7"]
    context: "Locazione ai sensi dell'art. 5, comma 3, della Legge n. 431/1998"
  ,
    requiredParameters: {
      required: [
      {
