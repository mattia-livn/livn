...
export const imuRatesNoliSV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Collocazione immobile: In una zona specificamente indicata dal comune: Immobili di Via elvede ancora inte ssati da ordinanza Sindacale n. 1720 del 16/12/2009 e n. 1724 del 20/01/2010 e n. 1789 del 19/05/2011",
    ratePercent: 0.4
    categoryTypes: []
    context: "In una zona specificamente indicata dal comune"
    zone: "Immobili di Via elvede ancora interessati da ordinanza Sindacale n. 1720 del 16/12/2009 e n. 1724 del 20/01/2010 e n. 1789 del 19/05/2011"
  ,
    requiredParameters: {
      required: [
      {
