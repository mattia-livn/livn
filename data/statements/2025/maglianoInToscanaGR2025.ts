...
export const imuRatesMaglianoInToscanaGR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D - Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito",
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D - Immobili di categoria A10, C - Immobili utilizzati",
    details: "Altri fabbricati fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D - Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili utilizzati",
    ratePercent: 0.86,
    categoryTypes: ["A10","C"]
  ,
    requiredParameters: {
