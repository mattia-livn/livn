...
export const imuRatesPomiglianoDarconan2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati di proprietà di ONLUS o enti del terzo settore, diverse da residenziali",
    details: "A e Fabbricabili - Tipologia: Diverse da sidenziali - Di propriet� di ONLUS o enti del terzo setto",
    ratePercent: 0.86
    categoryTypes: []
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: ONLUS o altri enti del terzo setto",
    ratePercent: 0.86
    categoryTypes: []
