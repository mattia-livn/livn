...
export const imuRatesGaioleInChiantiSI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione a canone libero - Durata del contratto di durata non inferio a mesi, specifica : 18",
    ratePercent: 0.96,
    categoryTypes: []
  ,
    requiredParameters: {
