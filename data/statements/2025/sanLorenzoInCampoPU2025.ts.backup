...
export const imuRatesSanLorenzoInCampoPU2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Categoria catastale: D/6 Fabbricati e locali per esercizi sportivi con fine di lucro",
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Categoria catastale: D/5 Istituto di credito, cambio e assicurazione con fine di lucro",
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Potenza impianti produzione energia, superio a kW: 200",
    ratePercent: 1.06
    categoryTypes: ["D/1"]
  ,
    requiredParameters: {
