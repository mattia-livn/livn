...
export const imuRatesPortovenereSP2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    ratePercent: 0.86
    categoryTypes: []
    context: "Locazione, uso abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.86
    categoryTypes: []
    context: "Comodato d'uso gratuito, uso abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria C, categorie catastali: C/1, C/2, C/3, C/4, C/5, C/6, C/7",
