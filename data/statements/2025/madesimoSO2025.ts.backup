...
export const imuRatesMadesimoSO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria D/2 e D/8",
    details: "Categoria catastale: - D/2 Alberghi e pensioni con fine di lucro - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 0.76
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D, categoria A/10, C/1, C/3",
    details: "Immobili di categoria A10, , C Categoria catastale: - A/10 Uffici e studi privati - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - /4 Uffici pubblici - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri",
    ratePercent: 0.76
