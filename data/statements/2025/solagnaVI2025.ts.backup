...
export const imuRatesSolagnaVI2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/2 Alberghi e pensioni con fine di lucro - Collocazione immobile: In una zona specificamente indicata dal comune: Massiccio del Grappa altitudine sopra i 600 metri",
    ratePercent: 0.76
    categoryTypes: ["D/2"]
    context: "Alberghi e pensioni con fine di lucro"
    zone: "Massiccio del Grappa altitudine sopra i 600 metri"
  ,
    requiredParameters: {
      required: [
      {
