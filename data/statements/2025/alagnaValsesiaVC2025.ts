...
export const imuRatesAlagnaValsesiaVC2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Collocazione immobile: In una zona specificamente indicata dal comune: Vallate di Otro, Olen, Sesia, Sesia territorio ex Riva Valdobbia, Mud, Campo, Vogna, Maccagno - sussistono limitazioni specifiche per le aree elencate e censite annualmente in delibera di approvazione aliquote IMU",
    ratePercent: 0.86,
    categoryTypes: [],
    context: "Tipo contratto: Locazione o comodato d'uso gratuito",
    zone: "Vallate di Otro, Olen, Sesia, Sesia territorio ex Riva Valdobbia, Mud, Campo, Vogna, Maccagno"
  ,
    requiredParameters: {
      required: [
      {
