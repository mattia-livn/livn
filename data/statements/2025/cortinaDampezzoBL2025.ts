...
export const imuRatesCortinaDampezzoBL2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al terzo grado in linea retta e collaterale",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al terzo grado in linea tta e collaterale - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: - A/11 Abitazioni ed alloggi tipici dei luoghi",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: - A/11 Abitazioni ed alloggi tipici dei luoghi",
    ratePercent: 0.51
    categoryTypes: ["A/11"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/11 Abitazioni ed alloggi tipici dei luoghi",
