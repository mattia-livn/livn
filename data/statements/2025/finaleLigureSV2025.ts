...
export const imuRatesFinaleLigureSV2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/5 Istituto di credito, cambio e assicurazione con fine di lucro",
    ratePercent: 1.06,
    categoryTypes: ["D/5"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie catastali D/1, D/3, D/4, D/6, D/7, D/8, D/9",
    ...
    ratePercent: 0.86,
    categoryTypes: ["D/1","D/3","D/4","D/6","D/7","D/8","D/9"],
  ...
  {
    condition: "Altri fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo catastale D, categorie catastali A/10, C",
