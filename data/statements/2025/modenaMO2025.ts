...
export const imuRatesModenaMO2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/4 Case di cura ed ospedali con fine di lucro - D/2 Alberghi e pensioni con fine di lucro - D/6 Fabbricati e locali per esercizi sportivi con fine di lucro - D/9 Edifici galleggianti o sospesi assicurati a punti fissi del suolo, ponti privati soggetti a pedaggio - D/3 Teatri, cinematografi, sale per concerti e spettacoli e simili con fine di lucro - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 1.05,
    categoryTypes: ["D/7","D/8","D/4","D/2","D/6","D/9","D/3","D/1"]
  ,
    requiredParameters: {
      required: [],
      conditional: [],
