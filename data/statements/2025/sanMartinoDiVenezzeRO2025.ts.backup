...
export const imuRatesSanMartinoDiVenezzeRO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Abitazioni residenziali situate in determinate zone",
    details: "- Tipologia: Residenziali - Situate in determinate zone: Situate in zona C/3 \"Zona di PEEP\" e C5 \"Zona indiziata per PEEP\"",
    ratePercent: 0.76
    categoryTypes: []
    context: "Situate in zona C/3 \"Zona di PEEP\" e C5 \"Zona indiziata per PEEP\""
    zone: "C/3, C5"
  ,
    requiredParameters: {
      required: [],
    ...
    },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi diverse da quella di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.74
