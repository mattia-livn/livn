...
export const imuRatesReccoGE2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/5 Stabilimenti balneari e di acque curative senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili concessi in comodato - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.86
    categoryTypes: ["C/1","C/3","C/5"]
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - C/5 Stabilimenti balneari e di acque curative senza fine di lucro - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.86
    categoryTypes: ["C/1","C/3","C/5"]
  ,
    requiredParameters: {
