...
export const imuRatesBardinetoSV2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito - Condizioni locatario/comodatario: Parenti - Sino al secondo grado in linea retta - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.56,
    categoryTypes: [],
    context: "Locazione o comodato d'uso gratuito, parenti sino al secondo grado in linea retta"
  ,
    requiredParameters: {
      required: [
      {
