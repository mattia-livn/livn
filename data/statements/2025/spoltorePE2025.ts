...
export const imuRatesSpoltorePE2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    ratePercent: 0.96,
    categoryTypes: [],
    context: "Locazione ai sensi dell'art. 2, comma 1"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.96,
    categoryTypes: [],
    context: "Locazione ai sensi dell'art. 5, comma 1"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.96,
    categoryTypes: [],
    context: "Locazione a studenti ai sensi dell'art. 5, comma 2"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    ratePercent: 0.96,
    categoryTypes: [],
    context: "Locazione ai sensi dell'art. 5, comma 3"
  ,
    requiredParameters: {
      required: [
      {
