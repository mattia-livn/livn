...
export const imuRatesMontegrottoTermePD2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/1 e D/5",
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - D/5 Istituto di c dito, cambio e assicurazione con fine di lucro",
    ratePercent: 1.06
  ...
  {
    condition: "Immobili di categoria C/1, fabbricati a disposizione o utilizzati",
  ...
  {
    condition: "Immobili di categoria C/1, fabbricati a disposizione o utilizzati, immobili locati",
