...
export const imuRatesTeoraAV2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione, Categoria catastale: A/2 Abitazioni di tipo civile",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione Categoria catastale: - A/2 Abitazioni di tipo civile - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.5,
    categoryTypes: ["A/2"],
