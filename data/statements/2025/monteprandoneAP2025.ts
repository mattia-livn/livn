...
export const imuRatesMonteprandoneAP2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato, condizioni particolari",
    ...
    context: "Comodato d'uso gratuito, condizioni particolari"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato, condizioni diverse",
    ...
    ratePercent: 0.66,
    categoryTypes: [],
    context: "Comodato d'uso gratuito, condizioni diverse"
  ,
    requiredParameters: {
      required: [
      {
