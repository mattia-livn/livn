...
export const imuRatesSanGregorioMagnoSA2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Collocazione immobile: In una zona specificamente indicata dal comune: Parco Eolico in località Monte Moio.",
    ratePercent: 1.06
    categoryTypes: ["D/1"]
    context: "Collocazione immobile: In una zona specificamente indicata dal comune"
    zone: "Parco Eolico in località Monte Moio"
  ,
    requiredParameters: {
      required: [
      {
