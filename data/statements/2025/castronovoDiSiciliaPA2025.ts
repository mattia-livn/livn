...
export const imuRatesCastronovoDiSiciliaPA2025: ImuRateEntry[] = [
  ...
  {
    condition: "Esercizi commerciali e artigianali situati in zone precluse al traffico a causa dello svolgimento di lavori per la realizzazione di opere pubbliche che si protraggono per oltre sei mesi",
    details: "- esercizi commerciali e artigianali situati in zone p cluse al traffico a causa dello svolgimento di lavori per la alizzazione di ope pubbliche che si protraggono per olt sei mesi art. 1, comma 86, della legge n. 549 del 1995 con aliquota agevolata applicata: 0,53%",
    ratePercent: 0.53
    categoryTypes: []
    context: "art. 1, comma 86, della legge n. 549 del 1995"
    zone: "zone precluse al traffico"
  ,
    requiredParameters: {
      required: [],
      conditional: [
      ...
      },
  {
    ...
    details: "- immobili di proprietà di ONLUS o enti del terzo setto",
    ratePercent: 0
    categoryTypes: []
  ,
    requiredParameters: {
