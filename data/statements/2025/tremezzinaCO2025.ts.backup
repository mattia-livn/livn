...
export const imuRatesTremezzinaCO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Collocazione immobile: In una zona specificamente indicata dal comune: Immobili siti al di sopra del vincolo idrogeologico",
    ratePercent: 0.46
    categoryTypes: []
    context: "Immobili siti al di sopra del vincolo idrogeologico"
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito - C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte - Collocazione immobile: In una zona specificamente indicata dal comune: Immobili siti al di sopra del vincolo idrogeologico",
    ratePercent: 0.46
