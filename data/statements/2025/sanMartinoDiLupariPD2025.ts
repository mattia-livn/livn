...
export const imuRatesSanMartinoDiLupariPD2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    ratePercent: 0.96,
    categoryTypes: ["D/8"],
    context: "Fabbricati per attività commerciale"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.46,
