...
export const imuRatesCastelnovoDiSottoRE2025: ImuRateEntry[] = [
  ...
  },
  {
    ...
    "ratePercent": 0.00098,
    "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione a canone libero - Destinazione d'uso: Purch� l'affittuario/comodatario la utilizzi come abitazione principale.",
    "conditions": [
      {
        "description": "Condizione applicabile in base al regolamento comunale",
        "predicate": "true // Da specificare in base alle condizioni locali"
  ...
  },
  {
    ...
    "ratePercent": 0.00086,
    "officialDescription": "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 5, comma 1, della Legge n. 431/1998 e s.m.i. - Destinazione d'uso: Purch� l'affittuario/comodatario la utilizzi come abitazione principale.",
    "conditions": [
      {
        "description": "Condizione applicabile in base al regolamento comunale",
        "predicate": "true // Da specificare in base alle condizioni locali"
  ...
  {
    "label": "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Privi di ogni arredo, sprovvisti di utenze di fornitura attive di acqua, luce e gas",
    "ratePercent": 0.00106,
  ...
  {
    "label": "Immobili di categoria - /5 Scuole e laboratori scientifici",
    "ratePercent": 0.0002,
    "categoryTypes": [
      "/5"
    ],
    ...
    "conditions": [
      {
        "description": "L'entità ha categoria /5",
        "predicate": "['/5'].includes(entity.category)"
      }
    ]
  }
];
