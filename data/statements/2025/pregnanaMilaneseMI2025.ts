...
export const imuRatesPregnanaMilaneseMI2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato, categoria catastale A/2, A/3, A/4, A/5, A/6, A/7, in comodato d'uso gratuito",
  ...
  {
    condition: "Abitazione a disposizione, non locate e non concesse in comodato, categoria catastale A/2, A/3, A/4, A/5, A/6, A/7",
  ...
  {
    condition: "Immobili di categoria C, negozi e botteghe, superficie non superiore a 200 mq",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 200 MQ",
    ratePercent: 0.86,
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
      ...
      conditional: [
      {
            ...
            "type": "conditional",
            "questions": [
                  "Qual è la superficie dell'immobile in metri quadri?"
            ],
            "validationRules": [
                  "Must be numeric value in square meters"
            ],
