...
export const imuRatesSavignanoSulRubiconeFC2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    ratePercent: 0.45
    categoryTypes: []
    context: "unità immobiliare posseduta da anziani o disabili"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Immobili non produttivi di ddito fondiario art. 43 T.U.I.R.",
    ratePercent: 0.96
    categoryTypes: ["D"]
