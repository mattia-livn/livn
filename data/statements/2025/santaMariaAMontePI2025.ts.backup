...
export const imuRatesSantaMariaAMontePI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    zone: "Zone limitrofe a Impianto iogas"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale:",
    ratePercent: 0.954
    categoryTypes: []
