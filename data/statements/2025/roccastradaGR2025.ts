...
export const imuRatesRoccastradaGR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C, categoria C/1 e C/3",
  ...
  {
    condition: "Abitazione locata o in comodato, tipo contratto: Accordi/Patti territoriali con destinazione d'uso abitazione principale",
