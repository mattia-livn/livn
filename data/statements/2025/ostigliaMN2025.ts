...
export const imuRatesOstigliaMN2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati",
    ratePercent: 0.46
    categoryTypes: ["C/1","C/3"]
    context: "Fabbricati a disposizione o utilizzati: Immobili locati"
  ,
    requiredParameters: {
      required: [
      {
