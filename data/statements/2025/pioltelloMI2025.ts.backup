...
export const imuRatesPioltelloMI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe - Immobili locati",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati",
    ratePercent: 0.76
    categoryTypes: ["C/1"]
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe - Immobili utilizzati direttamente dal soggetto passivo",
      ...
      },
  {
    ...
    ratePercent: 0.76
    categoryTypes: ["A/1","A/2","A/3","A/4","A/5","A/7"]
