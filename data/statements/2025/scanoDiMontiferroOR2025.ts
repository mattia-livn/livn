...
export const imuRatesScanoDiMontiferroOR2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Utilizzo/Inutilizzo: Privi di ogni arredo, sprovvisti di utenze di fornitura attive di acqua, luce e gas",
    ratePercent: 0.43,
    categoryTypes: [],
    context: "Privi di ogni arredo, sprovvisti di utenze di fornitura attive di acqua, luce e gas"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popolare - A/5 Abitazioni di tipo ultrapopolare - A/6 Abitazioni di tipo rurale - A/11 Abitazioni ed alloggi tipici dei luoghi - Con contratto registrato - Condizioni locatario/comodatario: Parenti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale. - Limitatamente ad un solo immobile.",
    ratePercent: 0.43,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/11"],
    context: "Con contratto registrato, parenti sino al primo grado, destinazione d'uso come abitazione principale"
  ,
    requiredParameters: {
      required: [
      {
