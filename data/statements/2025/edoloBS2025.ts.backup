...
export const imuRatesEdoloBS2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria C, categoria catastale C/2, C/6",
    ...
    context: "Collocazione immobile: In una zona specificamente indicata dal comune: fuori dal centro abitato, fabbricati ex rurali AITE che non sono stati oggetto di interventi edilizi che ne hanno modificato la destinazione"
