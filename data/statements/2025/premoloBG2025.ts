...
export const imuRatesPremoloBG2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Aree fabbricabili situate in determinate zone: DISCARICA",
    details: "Aree Fabbricabili - Tipologia: Diverse da residenziali - Situate in determinate zone: DISCARICA",
    ratePercent: 1.06,
    categoryTypes: [],
    context: "Situate in determinate zone: DISCARICA",
    zone: "DISCARICA"
  ,
    requiredParameters: {
            "required": [
