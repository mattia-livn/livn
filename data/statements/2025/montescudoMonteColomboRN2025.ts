...
export const imuRatesMontescudoMonteColomboRN2025: ImuRateEntry[] = [
  ...
  ,
    requiredParameters: {
            ...
            "commune": "montescudoMonteColombo"
      },
  {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D locati",
  ...
  {
    condition: "Abitazione locata o in comodato purché l'affittuario/comodatario la utilizzi come abitazione principale",
