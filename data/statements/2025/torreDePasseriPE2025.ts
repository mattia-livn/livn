...
export const imuRatesTorreDePasseriPE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: In una zona specificamente indicata dal comune: Locali commerciali, industriali ed artigianali ,bar e ristoranti acondizioni che negli stessi risulti golarmente svolta la medesima attività,limitatamente alla zona del centro storico",
    ratePercent: 0.56
    categoryTypes: ["C/1","C/3"]
    context: "Locali commerciali, industriali ed artigianali, bar e ristoranti"
    zone: "Zona del centro storico"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
