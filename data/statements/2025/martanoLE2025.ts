...
export const imuRatesMartanoLE2025: ImuRateEntry[] = [
  ...
  {
    condition: "Aree fabbricabili - Tipologia: Diverse da residenziali - Situate in determinate zone: ZONA PIP/2",
    details: "Aree Fabbricabili - Tipologia: Diverse da sidenziali - Situate in determinate zone: ZONA PIP/2",
    ratePercent: 0.76
    categoryTypes: []
    zone: "ZONA PIP/2"
  ,
