...
export const imuRatesSimaxisOR2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    ratePercent: 0.96,
    categoryTypes: ["Gruppo D esclusa D/10"]
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "- esercizi commerciali e artigianali situati in zone p cluse al traffico a causa dello svolgimento di lavori per la alizzazione di ope pubbliche che si protraggono per olt sei mesi art. 1, comma 86, della legge n. 549 del 1995 con aliquota agevolata applicata: 0,46%.",
    ratePercent: 0.46,
    categoryTypes: [],
