...
export const imuRatesButtiglieraDastiAT2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 3 - 4 - 5 - 6 - 7 - 14 - 15 - 16 - 17 - 18 - 19 - 20 - 21",
    ratePercent: 0
    categoryTypes: []
    zone: "fogli catastali: 3 - 4 - 5 - 6 - 7 - 14 - 15 - 16 - 17 - 18 - 19 - 20 - 21"
  ,
    requiredParameters: {
      required: [],
      conditional: [
