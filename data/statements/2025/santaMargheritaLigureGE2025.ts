...
export const imuRatesSantaMargheritaLigureGE2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Durata del contratto di durata non inferio a mesi, specifica : 36 - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.66,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Condizioni locatario/comodatario: Pa nti - Sino al secondo grado in linea tta e collaterale - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.46,
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C locati",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/2 Magazzini e locali di deposito - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati",
    ratePercent: 0.86,
  ...
  {
    condition: "Immobili di categoria C senza fine di lucro",
  ...
  {
    condition: "Immobili di categoria A/10, C utilizzati per attività innovative - Start up",
