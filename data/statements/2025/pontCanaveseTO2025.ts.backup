...
export const imuRatesPontCanaveseTO2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D - Immobili ad uso produttivo classificati nel gruppo catastale D centrali idroelettriche, istituti di credito e relative pertinenze",
    details: "Fabbricati appartenenti al gruppo catastale D - Ulteriori condizioni non rinvenibili tra quelle proposte nella presente schermata stabilite dal comune, ai sensi dell’art. 1, comma 755, legge n. 160 del 2019, ai fini dell’applicazione dell’aliquota oltre la misura dell’1,06%: IMMOBILI AD USO PRODUTTIVO CLASSIFICATI NEL GRUPPO CATASTALE D CENTRALI IDROELETTRICHE, ISTITUTI DI CREDITO E RELATIVE PERTINENZE",
    ratePercent: 1.14
    categoryTypes: ["D"]
    context: "Immobili ad uso produttivo classificati nel gruppo catastale D centrali idroelettriche, istituti di credito e relative pertinenze"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
