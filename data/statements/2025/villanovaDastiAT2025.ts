...
export const imuRatesVillanovaDastiAT2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria C - Negozi e botteghe con superficie non inferiore a 250 mq",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non inferio a Mq 250 MQ",
    ratePercent: 0.95,
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
