...
export const imuRatesVillanovaMondoviCN2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 2, 6, 7, 8, 9, 11, 14, 29",
    ratePercent: 0.99
    categoryTypes: []
    zone: "fogli catastali: 2, 6, 7, 8, 9, 11, 14, 29"
  ,
    requiredParameters: {
      required: [],
      conditional: [
