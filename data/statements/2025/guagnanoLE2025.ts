...
export const imuRatesGuagnanoLE2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "Fabbricati appartenenti al gruppo catastale D Categoria catastale: - D/1 Opifici - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile nel caso di piccole e medie imp se",
    ratePercent: 0.86,
    categoryTypes: ["D/1"],
