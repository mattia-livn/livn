...
export const imuRatesGrimaldiCS2025: ImuRateEntry[] = [
    ...
    },
  {
    ...
    details: "- immobili conferiti in trust istituito a favo di persone con handicap grave di cui all'art. 6 della legge n. 112 del 2016 con aliquota agevolata applicata: 1,14%",
    ratePercent: 1.14
    categoryTypes: []
    context: "Aliquota agevolata"
  ,
