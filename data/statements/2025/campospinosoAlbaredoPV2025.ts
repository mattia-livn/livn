...
export const imuRatesCampospinosoAlbaredoPV2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 0.9
    categoryTypes: []
    context: "Diversi dall'abitazione principale e dai fabbricati gruppo D"
  ,
    requiredParameters: {
            "required": [
                  {
