...
export const imuRatesVeroliFR2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Immobili di categoria C in una zona specificamente indicata dal comune",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - C/3 Laboratori per arti e mestieri - Collocazione immobile: In una zona specificamente indicata dal comune: Centro storico delimitato da apposita planimetria allegata alla delibera di approvazione delle tariffe - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del locatario, comodatario o soggetto passivo utilizzato : Persona giuridica esercente attivita' d'imp sa da un numero di mesi non superio a: 12 - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0
    categoryTypes: ["C/1","C/3"]
    context: "Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo"
    zone: "Centro storico"
  ,
    requiredParameters: {
      required: [],
  ...
  {
    condition: "Abitazione utilizzata direttamente dal soggetto passivo con handicap grave",
    details: "Abitazione utilizzata di ttamente dal soggetto passivo Categoria catastale: - A/1 Abitazioni di tipo signorile - A/8 Abitazioni in ville - A/9 Castelli, palazzi di eminenti p gi artistici o storici - Requisiti del soggetto passivo: Portato di handicap grave riconosciuto ai sensi dell'art. 3, comma 3, della L. 104/92",
    ratePercent: 0.4
    categoryTypes: ["A/1","A/8","A/9"]
    context: "Portato di handicap grave riconosciuto ai sensi dell'art. 3, comma 3, della L. 104/92"
  ,
    requiredParameters: {
      required: [],
      conditional: [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione o comodato d'uso gratuito Categoria catastale:",
    ratePercent: 0.53
    categoryTypes: []
