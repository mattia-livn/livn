...
export const imuRatesMonselicePD2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria A10, C - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato",
      ...
      },
  {
    ...
    details: "Fabbricati di civile abitazione destinati ad alloggi sociali non adibiti ad abitazione principale per il periodo di espletamento delle attivit� di assegnazione",
    ratePercent: 0
    categoryTypes: []
  ,
    requiredParameters: {
