...
export const imuRatesPoveDelGrappaVI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Categoria catastale: - D/2 Alberghi e pensioni con fine di lucro - Collocazione immobile: In una zona specificamente indicata dal comune: MASSICCIO DEL GRAPPA ALTITUDINE SOPRA 600 MT",
    ratePercent: 0.76
    categoryTypes: ["D/2"]
    context: "Alberghi e pensioni con fine di lucro"
    zone: "MASSICCIO DEL GRAPPA ALTITUDINE SOPRA 600 MT"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie D/1 Opifici e D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attività commerciale",
    details: "Categoria catastale: - D/1 Opifici - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Persona fisica di eta' non superio ad anni: 80 - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 0.76
