...
export const imuRatesLaterinaPergineValdarnoAR2025: ImuRateEntry[] = [
  ...
  ,
    requiredParameters: {
            ...
            "commune": "laterinaPergineValdarno"
      },
  {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. - Durata del contratto di durata non inferio a mesi, specifica : 60 - Destinazione d'uso: Purchè l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.99,
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione destinata a struttura turistico-ricettiva condotta in forma imprenditoriale",
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Durata del contratto di durata non inferio a mesi, specifica : 60",
    ratePercent: 0.99,
    categoryTypes: []
  ,
    requiredParameters: {
