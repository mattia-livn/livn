...
export const imuRatesCarmignanoDiBrentaPD2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Limitatamente ad un solo immobile.",
    ratePercent: 0.76
    categoryTypes: []
  ,
    requiredParameters: {
