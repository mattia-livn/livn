...
export const imuRatesSantilarioDenzaRE2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili locati o concessi in comodato o utilizzati direttamente dal soggetto passivo - Impianti fotovoltaici con potenza superiore a 2000 kW",
    details: "Fabbricati appartenenti al gruppo catastale D - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Impianti fotovoltaici - Potenza impianti produzione energia, superio a kW: 2000",
    ratePercent: 1.06,
    categoryTypes: ["D"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria A/10, C/1, C/2, C/3, C/4",
    ...
    ratePercent: 1.04,
    categoryTypes: ["A/10","C/1","C/2","C/3","C/4"]
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. - Durata del contratto di durata non inferio a mesi, specifica : 36",
    ratePercent: 0.76,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione a studenti ai sensi dell'art. 5, comma 2, della Legge n. 431/1998 e s.m.i. - Durata del contratto di durata non inferio a mesi, specifica : 6 - Condizioni locatario/comodatario: Studenti",
    ratePercent: 0.76,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito - Con contratto gistrato - Condizioni locatario/comodatario: Pa nti - Sino al terzo grado in linea tta - Destinazione d'uso: Purch� l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 1,
    categoryTypes: []
  ,
    requiredParameters: {
