...
export const imuRatesPedavenaBL2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro",
      ...
      },
  {
    ...
    details: "Immobili di categoria Categoria catastale: - /1 Collegi e convitti, educandati; ricoveri; orfanotrofi; ospizi; conventi; seminari; caserme - Superficie: Non superio a Mq 1500 MQ",
    ratePercent: 0,
    categoryTypes: ["/1"],
    context: "Superficie: Non superiore a Mq 1500"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
