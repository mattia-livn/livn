...
export const imuRatesVaianoCremascoCR2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Immobili di categoria C - C/3 Laboratori per arti e mestieri, C/4 Fabbricati e locali per esercizi sportivi senza fine di lucro, C/5 Stabilimenti balneari e di acque curative senza fine di lucro",
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini",
    ratePercent: 1,
