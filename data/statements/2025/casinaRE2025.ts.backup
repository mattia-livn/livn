...
export const imuRatesCasinaRE2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/2 Magazzini e locali di deposito",
    ratePercent: 0.86
    categoryTypes: ["C/2"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Requisiti del soggetto passivo: Portato di handicap grave",
  ...
  {
    condition: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Requisiti del soggetto passivo: Soggetto con invalidità civile",
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Requisiti del soggetto passivo: Soggetto con invalidita' civile riconosciuta in percentuale non inferio al: 100%",
    ratePercent: 0.46
    categoryTypes: []
  ,
    requiredParameters: {
