...
export const imuRatesBassignanaAL2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali specifici",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: F.12, F.13, F.14, F.15, F.33",
    ratePercent: 0
    categoryTypes: []
    context: "Ricadenti nei fogli catastali specifici"
    zone: "F.12, F.13, F.14, F.15, F.33"
  ,
    requiredParameters: {
      required: [],
      conditional: [
