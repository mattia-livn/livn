...
export const imuRatesZuglianoVI2025: ImuRateEntry[] = [
  ...
  {
    condition: "Terreni agricoli ricadenti nei fogli catastali n.: 1,2,3,4,5,6,9",
    details: "Ter ni agricoli - Collocazione: Ricadenti nei fogli catastali n.: fogli catastali: 1,2,3,4,5,6,9",
    ratePercent: 0
    categoryTypes: []
    zone: "fogli catastali: 1,2,3,4,5,6,9"
  ,
    requiredParameters: {
      required: [],
      conditional: [
