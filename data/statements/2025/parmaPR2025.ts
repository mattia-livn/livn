...
export const imuRatesParmaPR2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato - Locazione con reddito ISEE del comodatario non superiore a € 35000",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale. - Reddito ISEE del comodatario non superio a € 35000",
    ratePercent: 0.6,
    categoryTypes: [],
    context: "Reddito ISEE del comodatario non superiore a € 35000"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata o in comodato - Comodato d'uso gratuito a parenti sino al primo grado",
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/6 Abitazioni di tipo rurale - A/7 Abitazioni in villini - A/11 Abitazioni ed alloggi tipici dei luoghi - Condizioni locatario/comodatario: Pa nti - Sino al primo grado ipotesi di cui all'art. 1, comma 747, lett. c, della legge n. 160 del 2019 - Destinazione d'uso: Purché l'affittuario/comodatario la utilizzi come abitazione principale.",
    ratePercent: 0.8,
  ...
  {
    condition: "Abitazione locata o in comodato - Comodato d'uso gratuito a parenti sino al primo grado, ipotesi diverse",
    ...
    ratePercent: 0.8,
    categoryTypes: ["A/2","A/3","A/4","A/5","A/6","A/7","A/11"],
    context: "Comodato d'uso gratuito a parenti sino al primo grado, ipotesi diverse"
  ,
    requiredParameters: {
      required: [
      {
