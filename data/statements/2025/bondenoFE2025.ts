...
export const imuRatesBondenoFE2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto di durata non inferiore a 36 mesi",
    ...
    context: "Contratto di durata non inferiore a 36 mesi"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Superficie: Non superio a Mq 250 MQ - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Tipologia di attivit�: Attivita' innovative - Start up",
    ratePercent: 0.46,
    categoryTypes: ["C/1"],
