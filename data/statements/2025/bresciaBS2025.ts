...
export const imuRatesBresciaBS2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati di proprietà di ONLUS o enti del terzo settore a disposizione",
  ...
  {
    condition: "Fabbricati di proprietà di ONLUS o enti del terzo settore utilizzati direttamente",
  ...
  {
    condition: "Terreni agricoli ricadenti in determinate aree",
    details: "Ter ni agricoli - Collocazione: Ter ni ricadenti in determinate a e: A a: Individuata dall'ordinanza sindacale n. 208 del 20.11.2024",
    ratePercent: 0,
    categoryTypes: [],
    zone: "Individuata dall'ordinanza sindacale n. 208 del 20.11.2024"
  ,
    requiredParameters: {
      required: [],
      conditional: [
  ...
  {
    condition: "Abitazione locata o in comodato ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i.",
  ...
  {
    condition: "Abitazione locata o in comodato ai sensi dell'art. 5, comma 1, della Legge n. 431/1998 e s.m.i.",
  ...
  {
    condition: "Abitazione locata o in comodato ai sensi dell'art. 5, comma 3, della Legge n. 431/1998 e s.m.i.",
      ...
      },
  {
    ...
    details: "Fabbricati di civile abitazione destinati ad alloggi sociali non adibiti ad abitazione principale per il periodo di espletamento",
    ratePercent: 0.66,
    categoryTypes: [],
