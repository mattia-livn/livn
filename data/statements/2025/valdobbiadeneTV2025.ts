...
export const imuRatesValdobbiadeneTV2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Fabbricati di categoria catastale D/5 Istituto di credito, cambio e assicurazione con fine di lucro",
      ...
      },
  {
    ...
    details: "Fabbricati di civile abitazione destinati ad alloggi sociali non adibiti ad abitazione principale per il periodo di espletamento delle attivit� di assegnazione Fino a mesi: 24",
    ratePercent: 0,
    categoryTypes: [],
    context: "Fino a mesi: 24"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria A/10, C/1",
    details: "Immobili di categoria A10, C Categoria catastale: - A/10 Uffici e studi privati - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo - Codice ATECO: 64.19.10 - Intermediazione monetaria di istituti monetari diverse dalle anche centrali",
    ratePercent: 1.06,
    categoryTypes: ["A/10","C/1"],
    context: "Codice ATECO: 64.19.10"
  ,
    requiredParameters: {
      required: [
      {
