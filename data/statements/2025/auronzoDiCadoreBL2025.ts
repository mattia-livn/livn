...
export const imuRatesAuronzoDiCadoreBL2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria A/10, C utilizzati per attività produttiva e/o commerciale o per l'esercizio di arti e professioni",
  ...
  {
    condition: "Abitazione utilizzata direttamente dal soggetto passivo di categoria catastale A/11",
    details: "Abitazione utilizzata di ttamente dal soggetto passivo Categoria catastale: - A/11 Abitazioni ed alloggi tipici dei luoghi",
    ratePercent: 0.5,
    categoryTypes: ["A/11"]
  ,
    requiredParameters: {
