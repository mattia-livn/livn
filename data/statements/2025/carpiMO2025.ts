...
export const imuRatesCarpiMO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazioni non locate e non concesse in comodato",
    details: "- Abitazioni non locate e non concesse in comodato",
    ratePercent: 1.06,
    categoryTypes: []
  ,
    requiredParameters: {
      ...
      },
  {
    ...
    context: "Comodato d'uso gratuito a ONLUS o altri enti del terzo settore"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Abitazione locata a soggetti in condizioni di vulnerabilità sociale",
    ...
    ratePercent: 0.5,
    categoryTypes: [],
    context: "Locazione a soggetti in condizioni di vulnerabilità sociale"
  ,
    requiredParameters: {
      required: [
      {
