...
export const imuRatesCasalpusterlengoLO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati di categoria D/2 Alberghi e pensioni con fine di lucro",
    details: "Categoria catastale: - D/2 Alberghi e pensioni con fine di lucro - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato o utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.76,
    categoryTypes: ["D/2"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe locati privi o che intendono dismettere giochi di azzardo",
    details: "Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati - Destinazione d'uso: Privi o che intendono dismette giochi di azzardo",
    ratePercent: 0.76,
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe utilizzati direttamente dal soggetto passivo privi o che intendono dismettere giochi di azzardo",
    details: "Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: Privi o che intendono dismette giochi di azzardo",
    ratePercent: 0.76,
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C/1 Negozi e botteghe utilizzati direttamente dal soggetto passivo",
    details: "Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.86,
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C/3 Laboratori per arti e mestieri utilizzati direttamente dal soggetto passivo",
    details: "Categoria catastale: - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo",
    ratePercent: 0.86,
    categoryTypes: ["C/3"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C/3 Laboratori per arti e mestieri locati",
    details: "Categoria catastale: - C/3 Laboratori per arti e mestieri - Fabbricati a disposizione o utilizzati: Immobili locati",
    ratePercent: 0.86,
    categoryTypes: ["C/3"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato d'uso gratuito di categoria A/2, A/3, A/4, A/5, A/6, A/7",
