...
export const imuRatesVasiaIM2025: ImuRateEntry[] = [
  {
  condition: string; // short summary of the use case
  details: string; // original wording from the PDF
  ratePercent: number; // aliquota as percentage
      ...
      },
  {
    ...
    ratePercent: 0.5
    categoryTypes: []
    context: "Situate in determinate zone con permesso di costruire"
    zone: "Zone specifiche con permesso di costruire"
  ,
    requiredParameters: {
            "required": [
                  {
