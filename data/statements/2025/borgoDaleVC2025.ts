...
export const imuRatesBorgoDaleVC2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Terreni agricoli coltivati e destinati ad alcuni tipi di coltura: frutteti irrigui",
    details: "Ter ni agricoli - Utilizzo: Coltivati e destinati ad alcuni tipi di coltura: FRUTT I IRRIGUI",
    ratePercent: 0.42,
    categoryTypes: [],
    context: "Coltivati e destinati ad alcuni tipi di coltura: frutteti irrigui"
  ,
    requiredParameters: {
      required: [
      {
