...
export const imuRatesNichelinoTO2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione locata o in comodato - Tipo contratto: Locazione ai sensi dell'art. 2, comma 3, della Legge n.431/1998 e s.m.i. con reddito ISEE del comodatario non superiore a € 26.000,00",
    ...
    context: "Locazione con reddito ISEE del comodatario non superiore a € 26.000,00"
  ,
    requiredParameters: {
      required: [
      {
