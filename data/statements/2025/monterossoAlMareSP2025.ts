...
export const imuRatesMonterossoAlMareSP2025: ImuRateEntry[] = [
  ...
  {
    condition: "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.2",
    details: "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.2 - ALLOGGI PER VACANZE E ALTRE STRUTTURE PER REVI SOGGIORNI",
    ratePercent: 0.85
    categoryTypes: []
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.9",
    details: "Abitazione destinata a struttura turistico-ricettiva - Codice ATECO: 55.9 - ALTRI ALLOGGI",
    ratePercent: 0.85
    categoryTypes: []
  ,
    requiredParameters: {
