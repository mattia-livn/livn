...
export const imuRatesMontegiorgioFM2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D (D/1, D/2, D/3, D/4, D/6, D/7, D/8, D/9)",
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D (D/5)",
