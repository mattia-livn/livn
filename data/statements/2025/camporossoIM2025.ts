...
export const imuRatesCamporossoIM2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "- Utilizzo: Coltivati e destinati ad alcuni tipi di coltura: OR. IR. FI. e ROS O esclusi i coltivatori di tti o imp nditori agricoli professionali iscritti alla p videnza agricola",
    ratePercent: 0.5,
    categoryTypes: [],
    context: "esclusi i coltivatori diretti o imprenditori agricoli professionali iscritti alla previdenza agricola"
  ,
    requiredParameters: {
      required: [
      {
