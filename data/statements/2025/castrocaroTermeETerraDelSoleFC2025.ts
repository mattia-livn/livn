...
export const imuRatesCastrocaroTermeETerraDelSoleFC2025: ImuRateEntry[] = [
  ...
  ,
    requiredParameters: {
            ...
            "commune": "castrocaroTermeETerraDelSole"
      },
  {
  ...
  {
    condition: "Terreni agricoli ricadenti in determinate aree: Zona Montana",
    details: "- Collocazione: Ter ni ricadenti in determinate a e: A a: ZONA MONTANA",
    ratePercent: 0,
    categoryTypes: [],
    zone: "Zona Montana"
  ,
