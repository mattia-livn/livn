...
export const imuRatesCastelnuovoDelGardaVR2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "- Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Requisiti soggettivi del soggetto passivo utilizzato : Utilizzato di tto dell' immobile tutti - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.76,
    categoryTypes: [],
      ...
      },
  {
    ...
    context: "Locata o in comodato",
    zone: "Territorio Comunale"
  ,
    requiredParameters: {
      required: [
      {
    ...
    },
  {
    ...
    details: "- C/6 Stalle, scuderie, rimesse, autorimesse senza fine di lucro - C/7 Tettoie chiuse od aperte - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Con contratto gistrato *Per contratti di locazione di immobili devono intendersi esclusivamente quelli gistrati ai sensi delle vigenti disposizioni di legge. - Limitatamente ad un solo immobile.",
    ratePercent: 0.6,
    categoryTypes: ["C/6","C/7"],
    context: "Locati o concessi in comodato"
  ,
    requiredParameters: {
      required: [
      {
      ...
      },
  {
    ...
    details: "Immobili di categoria A10, , C - Fabbricati a disposizione o utilizzati: Immobili utilizzati di ttamente dal soggetto passivo - Destinazione d'uso: ottega storica o artigiana",
    ratePercent: 0.76,
    categoryTypes: ["A10","C"],
