...
export const imuRatesMesagneBR2025: ImuRateEntry[] = [
  {
      ...
      },
  {
    ...
    details: "A e Fabbricabili - Tipologia: Residenziali - Situate in determinate zone: A e fabbricabili ricadenti nel PRG in zona tipizzata C senza strumento attuativo",
    ratePercent: 0.5,
    categoryTypes: [],
    context: "Situate in determinate zone",
    zone: "PRG in zona tipizzata C senza strumento attuativo"
  ,
    requiredParameters: {
      required: [],
      conditional: [],
