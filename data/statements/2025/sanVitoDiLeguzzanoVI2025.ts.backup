...
export const imuRatesSanVitoDiLeguzzanoVI2025: ImuRateEntry[] = [
      ...
      },
  {
    ...
    details: "Abitazione a disposizione - Abitazioni non locate e non concesse in comodato - Periodo non coperto da contratti purché la condizione di immobile a disposizione persista da almeno: 0",
    ratePercent: 1.06
    categoryTypes: []
  ,
    requiredParameters: {
