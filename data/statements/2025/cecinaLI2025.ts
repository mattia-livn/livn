...
export const imuRatesCecinaLI2025: ImuRateEntry[] = [
  {
  ...
  {
    condition: "Abitazione locata o in comodato con ulteriori condizioni stabilite dal comune",
    details: "Abitazione locata o in comodato - Tipo contratto: Locazione - Ulteriori condizioni non rinvenibili tra quelle proposte nella p sente schermata stabilite dal comune, ai sensi dell’art. 1, comma 755, legge n. 160",
    ratePercent: 1.14,
    categoryTypes: [],
    context: "Ulteriori condizioni stabilite dal comune"
  ,
    requiredParameters: {
      required: [
      {
  ...
  {
    condition: "Immobili di categoria A/10 e C utilizzati per attività produttiva e/o commerciale",
