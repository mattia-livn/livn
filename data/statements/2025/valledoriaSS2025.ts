...
export const imuRatesValledoriaSS2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C/1",
      ...
      },
  {
    ...
    details: "Abitazione locata o in comodato - Tipo contratto: Comodato d'uso gratuito Categoria catastale: - A/2 Abitazioni di tipo civile - A/3 Abitazioni di tipo economico - A/4 Abitazioni di tipo popola - A/5 Abitazioni di tipo ultrapopola - A/7 Abitazioni in villini - Con contratto gistrato",
    ratePercent: 1.05
