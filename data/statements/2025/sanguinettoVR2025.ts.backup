...
export const imuRatesSanguinettoVR2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categoria catastale D/2 e D/5",
    details: "Categoria catastale: - D/2 Alberghi e pensioni con fine di lucro - D/5 Istituto di c dito, cambio e assicurazione con fine di lucro",
    ratePercent: 1.06
  ...
  {
    condition: "Immobili di categoria A10, C - Oggetto di attività di recupero per miglioramento del decoro urbano o della classe energetica",
