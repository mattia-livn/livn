...
export const imuRatesAlassioSV2025: ImuRateEntry[] = [
  ...
  {
    condition: "Immobili di categoria C - C/1 Negozi e botteghe - Immobili locati o concessi in comodato",
    details: "Immobili di categoria C Categoria catastale: - C/1 Negozi e botteghe - Fabbricati a disposizione o utilizzati: Immobili locati o concessi in comodato - Destinazione d'uso: Utilizzato per attivita' produttiva e/o commerciale o per l'esercizio di arti e professioni",
    ratePercent: 1.06
    categoryTypes: ["C/1"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Immobili di categoria C - C/1 Negozi e botteghe - Immobili utilizzati direttamente dal soggetto passivo",
