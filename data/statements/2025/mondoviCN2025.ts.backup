...
export const imuRatesMondoviCN2025: ImuRateEntry[] = [
  ...
  {
    condition: "Fabbricati appartenenti al gruppo catastale D, categorie D/1, D/2, D/7, D/8",
    details: "Categoria catastale: - D/1 Opifici - D/2 Alberghi e pensioni con fine di lucro - D/7 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' industriale e non suscettibili di destinazione diversa senza radicali trasformazioni - D/8 Fabbricati costruiti o adattati per le speciali esigenze di un'attivita' commerciale e non suscettibili di destinazione diversa senza radicali trasformazioni",
    ratePercent: 0.76
      ...
      },
  {
    ...
    details: "- C/3 Laboratori per arti e mestieri",
    ratePercent: 0.99
    categoryTypes: ["C/3"]
  ,
    requiredParameters: {
  ...
  {
    condition: "Abitazione locata o in comodato con contratto registrato, categorie A/2, A/3, A/4, A/5, A/6, A/7, A/11",
